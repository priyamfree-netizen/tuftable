<div>
        ...
        <div class="space-y-4 mb-6">
            ...
            @if ($disableOrderTypePopup)
                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <x-select id="defaultOrderTypeId" class="w-full" wire:model.live="defaultOrderTypeId">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        <thead class="bg-gray-100 dark:bg-gray-700">
                                            <tr>
                                                ...
                                                <th scope="col" class="py-2.5 px-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                                    @lang('modules.settings.enableFromCustomerSite')
                                                </th>
                                                ...
                                                >
                                                    <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                                        <x-input
                                                            ...
                                                            type="text"
                                                            wire:model.defer="orderTypeFields.{{ $index }}.orderTypeName"
                                                            :disabled="$isDisabled"
                                                        />
                                                    ...
                                                    <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                                        <x-select
                                                            ...
                                                            class="w-full"
                                                            wire:model.defer="orderTypeFields.{{ $index }}.type"
                                                            :disabled="$isDisabled"
                                                        >
    ...
    <x-confirmation-modal wire:model.defer="confirmDeleteOrderTypeModal">
        <x-slot name="title">
