                        ...
                        <div class="rounded-md bg-gray-800 shadow-md">
                            <div class="px-6 py-5 text-center">
                                ...
                                @if(isset($o['show_order_number']) && $o['show_order_number'] && isset($o['display_number']) && $o['display_number'])
                                    <div class="text-base font-semibold text-gray-300 mt-1 tracking-wide">{{ $o['display_number'] }}</div>
                                @endif
                    ...
                    @forelse($readyOrders as $o)
                        ...
                        <div class="rounded-md bg-green-600 shadow-md">
                            <div class="px-8 py-6 text-center">
                                <div class="text-4xl font-extrabold tracking-wide">{{ $num }}</div>
                                @if(isset($o['show_order_number']) && $o['show_order_number'] && isset($o['display_number']) && $o['display_number'])
                                    <div class="text-base font-semibold text-green-100 mt-1 tracking-wide">{{ $o['display_number'] }}</div>
                                @endif
                                @if(isset($o['order_type']))
