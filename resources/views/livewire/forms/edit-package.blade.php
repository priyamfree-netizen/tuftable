                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        ...
                        <div class="grid grid-cols-2 mt-4">
                            <x-label for="isRecommended">
                                <div class="flex items-center cursor-pointer">
                                    <x-checkbox name="isRecommended" id="isRecommended" wire:model.defer="isRecommended" />
                            ...
                            <x-label for="isPrivate">
                                <div class="flex items-center cursor-pointer">
                                    <x-checkbox name="isPrivate" id="isPrivate" wire:model.defer="isPrivate" />
                                    <div class="select-none ms-2">
                    ...
                    @if($packageType != App\Enums\PackageType::TRIAL)
                        <div class="mt-4">
                            ...
                            <x-select id="sortOrder" class="block w-full mt-1" wire:model.defer="sortOrder">
                    ...
                    @if(!$isFree)
                        ...
                        @if($packageType == App\Enums\PackageType::LIFETIME)
                            <div class="mt-4">
                                ...
                                <x-input id="price" class="block w-full mt-1" type="number" min="0" wire:model.defer="price" />
                                <x-input-error for="price" class="mt-2" />
                            </div>
                            @if($paymentKey->paddle_status == 1)
                                <div class="mt-4">
                                    <x-label for="paddleLifetimePriceId" value="Paddle Lifetime Price ID" required="true" />
                                    <x-input id="paddleLifetimePriceId" class="block w-full mt-1" type="text" wire:model.defer="paddleLifetimePriceId" />
                        ...
                        @else
                            <div class="grid grid-cols-2 mt-4 gap-x-3 md:gap-x-5">
                                ...
                                <x-label for="halfYearlyStatus">
                                    <div class="flex items-center cursor-pointer">
                                        <x-checkbox name="halfYearlyStatus" id="halfYearlyStatus" wire:model.live="halfYearlyStatus" />
                                        <div class="select-none ms-2">
                                            @lang('modules.package.halfYearlyPlan')
                                        </div>
                                    </div>
                                </x-label>
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                            @if($monthlyStatus)
                                <div class="{{ $annualStatus ? 'col-span-1' : 'col-span-2' }} transition-all space-y-4">
                                    <div>
                                        ...
                                        <x-input id="monthlyPrice" class="block w-full mt-1" step="0.001" type="number" min="0" wire:model.defer="monthlyPrice" />
                                    ...
                                    @if($paymentKey->stripe_status == 1)
                                        <div>
                                            ...
                                            <x-input id="stripeMonthlyPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="stripeMonthlyPlanId" />
                                    ...
                                    @if($paymentKey->razorpay_status == 1)
                                        <div>
                                            ...
                                            <x-input id="razorpayMonthlyPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="razorpayMonthlyPlanId" />
                                    ...
                                    @if($paymentKey->flutterwave_status == 1)
                                        <div>
                                            ...
                                            <x-input id="flutterwaveMonthlyPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="flutterwaveMonthlyPlanId" />
                                    ...
                                    @if($paymentKey->paystack_status == 1)
                                        <div>
                                            ...
                                            <x-input id="paystackMonthlyPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="paystackMonthlyPlanId" />
                                    ...
                                    @if($paymentKey->paddle_status == 1)
                                        <div>
                                            ...
                                            <x-input id="paddleMonthlyPriceId" class="block w-full mt-1" type="text" wire:model.defer="paddleMonthlyPriceId" />
                            ...
                            @if($annualStatus)
                                <div class="{{ $monthlyStatus ? 'col-span-1' : 'col-span-2' }} transition-all space-y-4">
                                    <div>
                                        ...
                                        <x-input id="annualPrice" class="block w-full mt-1" step="0.001" type="number" min="0" wire:model.defer="annualPrice" />
                                    ...
                                    @if($paymentKey->stripe_status == 1)
                                        <div>
                                            ...
                                            <x-input id="stripeAnnualPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="stripeAnnualPlanId" />
                                    ...
                                    @if($paymentKey->razorpay_status == 1)
                                        <div>
                                            ...
                                            <x-input id="razorpayAnnualPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="razorpayAnnualPlanId" />
                                    ...
                                    @if($paymentKey->flutterwave_status == 1)
                                        <div>
                                            ...
                                            <x-input id="flutterwaveAnnualPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="flutterwaveAnnualPlanId" />
                                    ...
                                    @if($paymentKey->paystack_status == 1)
                                        <div>
                                            ...
                                            <x-input id="paystackAnnualPlanId" class="block w-full mt-1" type="text" min="0" wire:model.defer="paystackAnnualPlanId" />
                                    ...
                                    @if($paymentKey->paddle_status == 1)
                                        <div>
                                            ...
                                            <x-input id="paddleAnnualPriceId" class="block w-full mt-1" type="text" wire:model.defer="paddleAnnualPriceId" />
                            ...
                            @if($halfYearlyStatus)
                                <div class="col-span-2 transition-all space-y-4">
                                    <div>
                                        <x-label for="halfYearlyPrice"
                                            value="{{ __('modules.package.halfYearlyPrice') . ' (' . $currencySymbol . ') ' }}" required="true" />
                                        <x-input id="halfYearlyPrice" class="block w-full mt-1" step="0.001" type="number" min="0" wire:model.defer="halfYearlyPrice" />
                                    ...
                                    @if($paymentKey->stripe_status == 1)
                                        <div>
                                            ...
                                            <x-input id="stripeHalfYearlyPlanId" class="block w-full mt-1" type="text" wire:model.defer="stripeHalfYearlyPlanId" />
                                    ...
                                    @if($paymentKey->razorpay_status == 1)
                                        <div>
                                            ...
                                            <x-input id="razorpayHalfYearlyPlanId" class="block w-full mt-1" type="text" wire:model.defer="razorpayHalfYearlyPlanId" />
                                    ...
                                    @if($paymentKey->flutterwave_status == 1)
                                        <div>
                                            ...
                                            <x-input id="flutterwaveHalfYearlyPlanId" class="block w-full mt-1" type="text" wire:model.defer="flutterwaveHalfYearlyPlanId" />
                                    ...
                                    @if($paymentKey->paystack_status == 1)
                                        <div>
                                            ...
                                            <x-input id="paystackHalfYearlyPlanId" class="block w-full mt-1" type="text" wire:model.defer="paystackHalfYearlyPlanId" />
                                    ...
                                    @if($paymentKey->paddle_status == 1)
                                        <div>
                                            ...
                                            <x-input id="paddleHalfYearlyPriceId" class="block w-full mt-1" type="text" wire:model.defer="paddleHalfYearlyPriceId" />
                    ...
                    @if ($packageType == App\Enums\PackageType::TRIAL)
                        <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                            <div class="mt-4">
                                ...
                                <x-select id="trialStatus" class="block w-full mt-1" wire:model.defer="trialStatus">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex items-center mt-3">
                                    <x-label for="carryForwardSms">
                                        <div class="flex items-center cursor-pointer">
                                            <x-checkbox id="carryForwardSms" wire:model.defer="carryForwardSms" />
                                            <div class="select-none ms-2">
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-3">
                                ...
                                @if($isMenuItemSelected)
                                    <div>
                                        ...
                                        <x-input id="menuItemsLimit" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm" type="number" min="-1" wire:model.defer="menuItemsLimit" placeholder="" />
                                ...
                                @if($isOrderSelected)
                                    <div>
                                        ...
                                        <x-input id="orderLimit" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm" type="number" min="-1" wire:model.defer="orderLimit" placeholder="" />
                                ...
                                @if($isStaffSelected)
                                    <div>
                                        ...
                                        <x-input id="staffLimit" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm" type="number" min="-1" wire:model.defer="staffLimit" placeholder="" />
                    ...
                    @includeIf('aitools::partials.package-monthly-request-limit')
