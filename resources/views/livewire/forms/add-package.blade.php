                    ...
                    @if(!$isFree)
                        ...
                        @if($packageType == App\Enums\PackageType::LIFETIME->value)
                            <div class="mt-6">
                                ...
                                <x-input id="price" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm" type="number" min="0" wire:model.defer="price" />
                            ...
                            @if($paymentKey->paddle_status == 1)
                                <div class="mt-6">
                                    ...
                                    <x-input id="paddleLifetimePriceId" type="text" wire:model.defer="paddleLifetimePriceId" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"/>
                                    ...
                                    @if($monthlyStatus)
                                        <div class="space-y-4">
                                            <div>
                                                ...
                                                <x-input id="monthlyPrice" type="number" step="0.001" min="0" wire:model.defer="monthlyPrice" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->stripe_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="stripeMonthlyPlanId" type="text" wire:model.defer="stripeMonthlyPlanId" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->razorpay_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="razorpayMonthlyPlanId" type="text" wire:model.defer="razorpayMonthlyPlanId" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->flutterwave_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="flutterwaveMonthlyPlanId" type="text" wire:model.defer="flutterwaveMonthlyPlanId" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->paystack_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="paystackMonthlyPlanId" type="text" wire:model.defer="paystackMonthlyPlanId" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->paddle_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="paddleMonthlyPriceId" type="text" wire:model.defer="paddleMonthlyPriceId" class="mt-1 block w-full"/>
                                    ...
                                    @if($annualStatus)
                                        <div class="space-y-4">
                                            <div>
                                                ...
                                                <x-input id="annualPrice" type="number" step="0.001" min="0" wire:model.defer="annualPrice" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->stripe_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="stripeAnnualPlanId" type="text" wire:model.defer="stripeAnnualPlanId" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->razorpay_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="razorpayAnnualPlanId" type="text" wire:model.defer="razorpayAnnualPlanId" class="mt-1 block w-full"/>
                                            ...
                                            @if($paymentKey->flutterwave_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="flutterwaveAnnualPlanId" type="text" wire:model.defer="flutterwaveAnnualPlanId" class="mt-1 block w-full" />
                                            ...
                                            @if($paymentKey->paystack_status == 1)
                                                <div>
                                                    ...
                                                    <x-input id="paystackAnnualPlanId" type="text" wire:model.defer="paystackAnnualPlanId" class="mt-1 block w-full"/>
