<div>
    <div>
        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                ...
                <div class="items-center justify-between block sm:flex ">
                    <div class="flex items-center gap-3 mb-4 sm:mb-0">
                        <form class="sm:pr-3" action="#" method="GET">
                            ...
                            <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                                <x-input id="menu_name" class="block mt-1 w-full" type="text" placeholder="{{ __('placeholders.searchDuePayments') }}" wire:model.live.debounce.500ms="search"  />
                            </div>
                        </form>
                        <div class="w-48 mt-1 sm:w-64">
                            <x-select wire:model.live="filterCustomer" class="block mt-1 w-full">
                    ...
                    <a href="javascript:;" wire:click='exportDuePayments'
        ...
        <livewire:payments.due-payments-table :search="$search" :filterCustomer="$filterCustomer" key='payment-table-{{ microtime() }}' />
