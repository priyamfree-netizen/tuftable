    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center justify-start">
          ...
          <a href="<?php echo e(route('superadmin.dashboard')); ?>" class="flex ltr:ml-2 rtl:mr-24 items-center app-logo">
            <img src="<?php echo e(restaurantOrGlobalSetting()->logoUrl); ?>" class="h-8 ltr:mr-3 rtl:ml-3" alt="App Logo" />
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(restaurantOrGlobalSetting()->show_logo_text): ?>
              <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white hidden lg:block"><?php echo e(Str::limit(restaurantOrGlobalSetting()->name, 10)); ?></span>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2241608112-0', null);
          ...
          <div class="flex items-center w-8">
            ...
            <div
              ...
              <ul class="py-1" role="none">
                ...
                <li>
                    <a href="<?php echo e(route('superadmin.custom-modules.index')); ?>"
                      ...
                      role="menuitem">
                      <?php echo app('translator')->get('modules.settings.customModules'); ?>


                    </a>
                  </li>
                <li>
                  <a href="<?php echo e(route('superadmin.app-update.index')); ?>"
                    class="flex justify-between px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                    role="menuitem">
                    <?php echo app('translator')->get('menu.appUpdate'); ?>

                    <span class="bg-skin-base text-white text-xs font-medium px-1.5 py-0.5 rounded-full dark:bg-gray-500 dark:text-gray-300">v<?php echo e(\Illuminate\Support\Facades\File::get('version.txt')); ?></span>
                  </a>
                </li>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\superadmin-navigation-menu.blade.php ENDPATH**/ ?>