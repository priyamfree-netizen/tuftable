        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" wire:click.self="closeModal">
            <div class="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full relative">
                ...
                <div class="text-center">
                    <img src="<?php echo e(asset('img/Support_Extension_Cost.jpg')); ?>" alt="Support Extension Cost" class="max-w-full max-h-full mb-4">
                </div>
            </div>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\support-date-modal.blade.php ENDPATH**/ ?>