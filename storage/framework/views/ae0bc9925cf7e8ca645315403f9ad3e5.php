    ...
    <div class="container mx-auto px-4 py-6 max-w-2xl">
        <div class="flex flex-col items-center mb-12">
            <div class="flex items-center">
                <img src="<?php echo e(asset('img/logo.png')); ?>" class="h-12 w-auto" alt="TufTable Logo"/>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="bg-blue-50 rounded p-3 flex items-start text-sm">
                        ...
                        <div>
                            ...
                            <p class="text-blue-700"><?php echo e(\request()->getHost()); ?></p>
                        </div>
                    </div>
                        ...
                        <div class="ml-3">
                            <div class="text-sm text-green-700">
                                ...
                                <p class="mt-2">
                                    ...
                                    <br>
                                    <br>
                                    <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-800 underline">
...
<?php /**PATH C:\Users\denji\Documents\tuftable\tuftable\resources\views/vendor/froiden-envato/verify_purchase.blade.php ENDPATH**/ ?>