...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('modules.profile.twoFactorAuth')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('modules.profile.addSecurity')); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->enabled): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showingConfirmation): ?>
                    <?php echo e(__('modules.profile.finishEnablingTwoFactorAuth')); ?>

                <?php else: ?>
                    <?php echo e(__('modules.profile.enabledTwoFactorAuth')); ?>

                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php else: ?>
                <?php echo e(__('modules.profile.notEnabledTwoFactorAuth')); ?>
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <p>
                <?php echo e(__('modules.profile.twoFactorAuthMessage')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showingQrCode): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                    <p class="font-semibold">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showingConfirmation): ?>
                            <?php echo e(__('modules.profile.finishEnablingTwoFactorAuthMessage')); ?>

                        <?php else: ?>
                            <?php echo e(__('modules.profile.twoFactorAuthEnabledMessage')); ?>
                ...
                <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                    <p class="font-semibold">
                        <?php echo e(__('modules.profile.setupKey')); ?>: <?php echo e(decrypt($this->user->two_factor_secret)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'code','value' => ''.e(__('modules.profile.code')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'code','value' => ''.e(__('modules.profile.code')).'']); ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showingRecoveryCodes): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                    <p class="font-semibold">
                        <?php echo e(__('modules.profile.recoveryCodesMessage')); ?>
...
<?php $component->withAttributes(['class' => 'me-3']); ?>
                            <?php echo e(__('modules.profile.regenerateRecoveryCodes')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'me-3']); ?>
                            <?php echo e(__('modules.profile.showRecoveryCodes')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\profile\two-factor-authentication-form.blade.php ENDPATH**/ ?>