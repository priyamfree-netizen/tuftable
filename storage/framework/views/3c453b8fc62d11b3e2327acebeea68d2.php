                ...
                <div class="flex items-center gap-2">
                    ...
                    <?php else: ?>
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <span class="text-sm font-medium text-gray-900 ms-3 dark:text-gray-300"><?php echo app('translator')->get('app.autoRefresh'); ?></span>
                        </label>
    ...
    <div class="flex flex-col px-4 my-4">
        ...
        <div class="space-y-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex flex-col gap-3 space-y-1 sm:gap-4" wire:key='area-<?php echo e($area->id . microtime()); ?>'>
                    <h3 class="inline-flex items-center gap-2 font-medium f-15 dark:text-neutral-200"><?php echo e($area->area_name); ?>

                        <span class="px-2 py-1 text-sm text-gray-800 border border-gray-300 rounded bg-slate-100 "><?php echo e($area->tables->count()); ?> <?php echo app('translator')->get('modules.table.table'); ?></span>
                    </h3>
                    <!-- Card -->

                    <div class="grid gap-3 sm:grid-cols-3 2xl:grid-cols-4 sm:gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $area->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses(['group flex flex-col gap-2 border shadow-sm rounded-lg hover:shadow-md transition dark:bg-gray-700 dark:border-gray-600 p-3', 'bg-red-50' => ($item->status == 'inactive'), 'bg-white' => ($item->status == 'active')]); ?>"

                        wire:key='table-<?php echo e($item->id . microtime()); ?>'
                            href="javascript:;">
                            <div class="flex items-center justify-between w-full gap-4 cursor-pointer" wire:click='showTableOrder(<?php echo e($item->id); ?>)'>
                                ...
                                <div class="space-y-1">
                                    <p
                                    class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-xs font-medium dark:text-neutral-200 text-gray-500 inline-flex items-center gap-1']); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-stopwatch" viewBox="0 0 16 16">
                                        <path d="M8.5 5.6a.5.5 0 1 0-1 0v2.9h-3a.5.5 0 0 0 0 1H8a.5.5 0 0 0 .5-.5z"/>
                                        <path d="M6.5 1A.5.5 0 0 1 7 .5h2a.5.5 0 0 1 0 1v.57c1.36.196 2.594.78 3.584 1.64l.012-.013.354-.354-.354-.353a.5.5 0 0 1 .707-.708l1.414 1.415a.5.5 0 1 1-.707.707l-.353-.354-.354.354-.013.012A7 7 0 1 1 7 2.071V1.5a.5.5 0 0 1-.5-.5M8 3a6 6 0 1 0 .001 12A6 6 0 0 0 8 3"/>
                                      </svg>
                                        <?php echo e($item->activeWaiterRequest->created_at->diffForHumans()); ?>
                                    ...
                                    <div class="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <?php echo e($item->activeOrder->waiter->name ?? '--'); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->available_status == 'reserved'): ?>
                                        <div class="px-1 py-0.5 border bg-red-100 border-red-700 text-md text-red-700 rounded"><?php echo app('translator')->get('modules.table.reserved'); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'markCompleted('.e($item->activeWaiterRequest->id).')','class' => 'flex items-center gap-2 text-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'markCompleted('.e($item->activeWaiterRequest->id).')','class' => 'flex items-center gap-2 text-xs']); ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
                                            <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0"/>
                                            <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
                                        </svg>
                                        <?php echo app('translator')->get('modules.waiterRequest.markCompleted'); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <div class="flex flex-col items-center justify-center p-8 text-gray-500 bg-white rounded-lg col-span-full dark:text-gray-400 dark:bg-gray-800">
                            ...
                            <p class="text-sm"><?php echo app('translator')->get('modules.waiterRequest.noWaiterRequest'); ?></p>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views/livewire/waiter-request/tables.blade.php ENDPATH**/ ?>