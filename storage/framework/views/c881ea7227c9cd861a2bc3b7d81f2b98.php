...
<div x-data="{
    is24Hour: <?php echo e($is24Hour ? 'true' : 'false'); ?>,
    timeFormat: '<?php echo e($timeFormat); ?>',
    hours: <?php echo e($hour12); ?>,
    minutes: <?php echo e($minute); ?>,
    ampm: '<?php echo e($ampmValue); ?>',
    isUpperCaseAmPm: <?php echo e($isUpperCaseAmPm ? 'true' : 'false'); ?>,
    showPicker: false,
    ...
    <input type="text" x-ref="input" x-model="displayValue" @input="handleInput($event)" @click="togglePicker()" readonly
        <?php echo $attributes->merge(['class' => 'inline-flex items-center pl-4 pr-5 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-lg text-lg text-gray-700 dark:text-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 w-full cursor-pointer relative z-10']); ?>>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\components\time-picker.blade.php ENDPATH**/ ?>