<div
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderTypeId): ?>
    <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 pb-2 flex items-center justify-between">
        <div class="flex items-center gap-3">
            <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo app('translator')->get('modules.settings.orderType'); ?>:</span>
            <span class="text-sm font-semibold text-gray-900 dark:text-white">
                <?php echo e(\App\Models\OrderType::find($orderTypeId)?->order_type_name ?? ucfirst($orderType)); ?>

            </span>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderTypeSlug === 'delivery' && $selectedDeliveryApp): ?>
                ...
                <span class="text-sm font-medium text-gray-900 dark:text-white">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedDeliveryApp === 'default'): ?>
                        Default
                    <?php else: ?>
        ...
        <div class="mt-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customerId): ?>
                <div class="flex items-center gap-2">
                    <div class="font-semibold text-gray-700 dark:text-gray-300"><?php echo e($customer->name); ?></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Update Order')): ?>
                        <button  wire:click="$dispatch('showAddCustomerModal', { customerId: <?php echo e($customerId); ?> })" title="<?php echo e(__('modules.order.updateCustomerDetails')); ?>" class="p-1 text-gray-500 transition-colors bg-gray-100 rounded-md hover:text-gray-700 hover:bg-gray-200 rtl:ml-2 ltr:mr-2 dark:text-gray-300 dark:bg-gray-600 dark:hover:text-gray-200 dark:hover:bg-gray-700">
            ...
            <?php else: ?>
                <a href="javascript:;"
                    ...
                    class="text-sm underline underline-offset-2 dark:text-gray-300">&plus; <?php echo app('translator')->get('modules.order.addCustomerDetails'); ?></a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        <div class="flex justify-between my-2 items-center">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderType == 'dine_in'): ?>
                <div class="inline-flex items-center gap-2 dark:text-gray-300">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tableNo): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-xs','wire:click' => 'openTableChangeConfirmation']); ?>
                                <?php echo app('translator')->get('modules.order.setTable'); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af)): ?>
<?php $attributes = $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af; ?>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'openMergeTableModal','class' => 'ml-2','title' => 'Merge Table']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'openMergeTableModal','class' => 'ml-2','title' => 'Merge Table']); ?>
        ...
        <div class="flex justify-between items-center gap-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderType == 'dine_in'): ?>
                <div class="inline-flex items-center gap-1 text-xs dark:text-gray-300">
                    <?php echo app('translator')->get('modules.order.noOfPax'); ?> <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'number','step' => '1','min' => '1','class' => 'w-16 text-xs','wire:model.defer' => 'noOfPax']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'number','step' => '1','min' => '1','class' => 'w-16 text-xs','wire:model.defer' => 'noOfPax']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="gap-2 inline-flex items-center">
                    <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['class' => 'relative text-xs','wire:click' => '$toggle(\'showKotNote\')','title' => __('modules.order.addNote'),'dataTooltipTarget' => 'tooltip-note']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'relative text-xs','wire:click' => '$toggle(\'showKotNote\')','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('modules.order.addNote')),'data-tooltip-target' => 'tooltip-note']); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->orderNote): ?>
...
<?php endif; ?>
                    ...
                    <div class="inline-flex items-center gap-2">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isWaiterLocked): ?>
                            <span
                                ...
                                title="<?php echo e($this->waiterName); ?>">
                                <?php echo e($this->waiterName); ?>

                            </span>
                        <?php else: ?>
                            <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['class' => 'text-xs w-36','wire:model.live' => 'selectWaiter','disabled' => $this->isWaiterLocked]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-xs w-36','wire:model.live' => 'selectWaiter','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->isWaiterLocked)]); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php echo e(($this->selectWaiter && $this->selectWaiter == $item->id) ? 'selected' : ''); ?>><?php echo e($item->name); ?></option>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datepicker','data' => ['wire:model.live' => 'pickupDate','value' => ''.e($currentDate).'','minDate' => ''.e($minDate).'','maxDate' => ''.e($maxDate).'','class' => 'pl-4 pr-5 py-2 text-lg text-gray-700 dark:text-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'pickupDate','value' => ''.e($currentDate).'','minDate' => ''.e($minDate).'','maxDate' => ''.e($maxDate).'','class' => 'pl-4 pr-5 py-2 text-lg text-gray-700 dark:text-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.time-picker','data' => ['wire:model.live' => 'pickupTime','value' => ''.e($currentTime).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'pickupTime','value' => ''.e($currentTime).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="flex flex-col rounded gap-1">
            ...
            ?>
            <div class="border border-gray-100 dark:border-gray-700 rounded-md p-2 flex flex-col gap-2 <?php echo e($isFreeItem ? 'border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-900/20' : ($hasStampDiscount ? 'border-blue-300 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/20' : '')); ?>">
                <div class="flex flex-col gap-1">
                    <div class="flex items-center justify-between">
                        <div class="flex flex-col gap-1">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($orderItemVariation[$key]) && $orderItemVariation[$key]): ?>
                            <span class="text-gray-500 dark:text-gray-400 text-xs">
                                &bull; <?php echo e($orderItemVariation[$key]->variation); ?>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <?php elseif($hasStampDiscount): ?>
                                <div class="flex flex-col items-end">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($originalAmount > 0 && $originalAmount > $totalAmount): ?>
                                        <div class="text-[10px] text-gray-400 line-through">
                                            <?php echo e(currency_format($originalAmount, restaurant()->currency_id)); ?>
                ...
                <div class="flex items-center gap-2 justify-between">
                    ...
                    <div class="text-xs text-gray-500 dark:text-gray-400">
                        <?php echo app('translator')->get('app.qty'); ?> <?php echo e($orderItemQty[$key] ?? 1); ?>
...
<?php endif; ?>
    ...
    <div class="sticky bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
        <div class="h-auto p-4 select-none text-center bg-gray-50 rounded space-y-2 dark:bg-gray-700">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($orderItemList) > 0): ?>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isLoyaltyEnabled() && $customerId && ($loyaltyPointsAvailable ?? 0) > 0): ?>
                        <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'openLoyaltyRedemptionModal','class' => 'bg-purple-100 text-purple-700 border-purple-300 hover:bg-purple-200 dark:bg-purple-900 dark:text-purple-300 dark:border-purple-700 dark:hover:bg-purple-800']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'openLoyaltyRedemptionModal','class' => 'bg-purple-100 text-purple-700 border-purple-300 hover:bg-purple-200 dark:bg-purple-900 dark:text-purple-300 dark:border-purple-700 dark:hover:bg-purple-800']); ?>
...
<?php endif; ?>
            ...
            <div class="flex justify-between text-gray-500 text-xs dark:text-neutral-400">
                <div class="flex items-center gap-2">
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isOrderPlaced && ($displayStampDiscountAmount > 0 || $hasFreeStampItems)): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(function_exists('module_enabled') && module_enabled('Loyalty')): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountAmount && $loyaltyPointsRedeemed == 0): ?>
                <div wire:key="discountAmount"
                    class="flex justify-between text-green-500 text-xs dark:text-green-400">
                    <div class="inline-flex items-center gap-x-1"><?php echo app('translator')->get('modules.order.discount'); ?> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountType == 'percent'): ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if((!$orderID || ($orderID && $orderDetail && $orderDetail->status == 'draft')) && count($orderItemList) > 0 && $extraCharges): ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php elseif($orderID && count($orderItemList) > 0 && $extraCharges): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $extraCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newKotCharge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div wire:key="extraCharge-newKot-<?php echo e($loop->index); ?>"
                        class="flex justify-between text-gray-500 text-xs dark:text-neutral-400">
                        <div class="inline-flex items-center gap-x-1"><?php echo e($newKotCharge->charge_name); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($newKotCharge->charge_type == 'percent'): ?>
                                (<?php echo e($newKotCharge->charge_value); ?>%)
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div>
                            <?php echo e(currency_format($newKotCharge->getAmount($discountedTotal), $restaurant->currency_id)); ?>
            ...
            <?php else: ?>
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($taxTotals)): ?>
                    ...
                    <div class="flex justify-between text-gray-500 text-sm dark:text-neutral-400">
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isInclusive): ?>
                                <span class="text-xs text-gray-400">(<?php echo app('translator')->get('modules.settings.taxInclusive'); ?>)</span>
                            <?php else: ?>
                                <span class="text-xs text-gray-400">(<?php echo app('translator')->get('modules.settings.taxExclusive'); ?>)</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div>
        ...
        <div class="h-auto pt-3 select-none text-center w-full">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$orderID || ($orderID && $orderDetail && $orderDetail->status !== 'draft')): ?>
                <div class="flex gap-3 mb-3">
                    <button class="rounded bg-yellow-600 hover:bg-yellow-700 text-white w-full p-2 relative" wire:click="saveOrder('draft')"
                        ...
                        <span wire:loading.remove wire:target="saveOrder('draft')">
                            <?php echo app('translator')->get('modules.order.saveAsDraft'); ?>
                        </span>
                        <span wire:loading wire:target="saveOrder('draft')" class="inline-flex items-center">
                            ...
                            <?php echo app('translator')->get('modules.order.saving'); ?>
                        </span>
                    </button>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('KOT', restaurant_modules())): ?>
                <div class="flex gap-3">
                    <button class="rounded bg-gray-700 text-white w-full p-2 relative <?php echo e($isPastTime ? 'opacity-50 cursor-not-allowed' : ''); ?>"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$orderID || ($orderID && $orderDetail && $orderDetail->status == 'draft')): ?>
                <div class="flex gap-3 mt-3">
                    <button class="rounded bg-skin-base text-white w-full p-2 relative <?php echo e($isPastTime ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                    ...
                    <button class="rounded bg-green-500 text-white w-full p-2 relative <?php echo e($isPastTime ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                    ...
                    <button class="rounded bg-blue-500 text-white w-full p-2 relative <?php echo e($isPastTime ? 'opacity-50 cursor-not-allowed' : ''); ?>"
            ...
            <div class="space-y-4">
                <div class="text-center">
                    ...
                    <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <p><?php echo app('translator')->get('modules.order.reservationTime'); ?>: <strong><?php echo e($this->reservation?->reservation_date_time?->translatedFormat(dateFormat() . ' ' . timeFormat()) ?? 'N/A'); ?></strong></p>
                    </div>
                </div>
...
<?php $component->withAttributes(['wire:model.live' => 'showMergeTableModal','maxWidth' => 'lg']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <div class="space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($tablesWithUnpaidOrders) > 0): ?>
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        <?php echo app('translator')->get('modules.order.mergeTableDescription'); ?>
                    </div>
                    <div class="max-h-96 overflow-y-auto">
                        <div class="grid grid-cols-1 gap-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tablesWithUnpaidOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer <?php echo e(in_array($table->id, $selectedTablesForMerge) ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-300 dark:border-blue-700' : ''); ?>">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="text-xs text-gray-500 dark:text-gray-400 ml-4">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($table->activeOrder): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedTablesForMerge) > 0): ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\pos\kot_items.blade.php ENDPATH**/ ?>