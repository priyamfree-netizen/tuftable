<div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
    'flex-col gap-3 items-center border bg-white shadow-sm rounded-lg hover:shadow-md transition dark:bg-gray-700 dark:border-gray-600 p-3 overflow-hidden',
]); ?>">
    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['group flex flex-col gap-3 items-center ']); ?>"
        <?php if($order->status == 'kot'): ?>
            href="<?php echo e(route('pos.kot', $order->id).'?show-order-detail=true'); ?>" wire:navigate
        <?php elseif($order->status == 'draft'): ?>
            href="<?php echo e(route('pos.draft', $order->id)); ?>" wire:navigate
        <?php else: ?>
            wire:click="$dispatch('showOrderDetail', { id: <?php echo e($order->id); ?> })"
        <?php endif; ?>
        wire:key='order-item-<?php echo e($order->id . microtime()); ?>' href="javascript:;">
        <div class="flex flex-col sm:flex-row gap-4 sm:justify-between w-full min-w-0">
            <div class="flex gap-3 space-y-1 min-w-0 flex-1">
                ...
                <div class="min-w-0 flex-1">
                    <div class="font-semibold text-gray-700 truncate text-sm dark:text-gray-300">
                        <?php echo e($order->customer ? ($order->customer->name ? $order->customer->name : __('modules.customer.walkin')) : '--'); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status != 'draft'): ?>
                        <div class="font-medium text-gray-600 text-sm dark:text-gray-400 truncate">
                            <?php echo e($order->show_formatted_order_number); ?>

                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->custom_order_type_name): ?>
                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate">
                            <?php echo e($order->custom_order_type_name); ?>

                        </div>
                    <?php elseif($order->orderType): ?>
                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate">
            ...
            <div class="ltr:text-right rtl:text-left flex-shrink-0">
                <div class="flex flex-col gap-1">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->placed_via): ?>
                        <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            'text-xs font-medium px-2 py-1 rounded uppercase tracking-wide inline-flex items-center flex-wrap gap-1',
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <span class="whitespace-nowrap"><?php echo e(__('app.via_' . $order->placed_via)); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_enabled('Kiosk') && class_exists(\Modules\Kiosk\Entities\Kiosk::class) && $order->kiosk): ?>
                                <span class="whitespace-nowrap">: <?php echo e($order->kiosk->code); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <div class="flex flex-col sm:flex-row w-full sm:justify-between sm:items-center gap-2 sm:gap-0">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->order_type == 'pickup'): ?>
                <div class="flex flex-col gap-1 text-xs text-gray-600 dark:text-gray-400 min-w-0">
                    <div class="flex items-center gap-1 flex-wrap">
                        <span class="font-semibold whitespace-nowrap"><?php echo app('translator')->get('modules.order.pickupDate'); ?></span>
                        <span class="truncate">
                            <?php
                    ...
                    <div class="flex items-center gap-1 flex-wrap">
                        <span class="font-semibold whitespace-nowrap"><?php echo app('translator')->get('modules.order.orderDate'); ?></span>
                        <span class="truncate"><?php echo e($order->date_time->timezone(timezone())->format(dateFormat() . ' ' . timeFormat())); ?></span>
                    </div>
                </div>
            <?php else: ?>
                <div class="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400 min-w-0 flex-wrap">
                    <span class="font-semibold whitespace-nowrap"><?php echo app('translator')->get('modules.order.orderDate'); ?></span>
                    <span class="truncate"><?php echo e($order->date_time->timezone(timezone())->format(dateFormat() . ' ' . timeFormat())); ?></span>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="text-sm font-medium text-gray-800 dark:text-gray-400 flex-shrink-0">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status == 'kot'): ?>
                    <?php echo e($order->kot->count()); ?> <?php echo app('translator')->get('modules.order.kot'); ?>
                <?php else: ?>
        ...
        <div class="flex flex-col sm:flex-row w-full sm:justify-between sm:items-center gap-2 sm:gap-0 border-t dark:border-gray-500 pt-3">
            <div class="inline-flex gap-1 items-center flex-shrink-0">
                <div class="text-lg font-medium text-gray-800 dark:text-gray-300">
                    <?php echo e(currency_format($order->display_total ?? $order->total ?? 0, restaurant()->currency_id)); ?>
            ...
            <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                <div class="text-xs text-gray-500 dark:text-gray-400 inline-flex gap-1 items-center flex-shrink-0">
                    ...
                    <span class="whitespace-nowrap"><?php echo app('translator')->get('modules.order.info_' . $order->order_status->value); ?></span>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status == 'kot' && user_can('Create Order')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-link','data' => ['href' => ''.e(route('pos.kot', ['id' => $order->id])).'','class' => 'text-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('pos.kot', ['id' => $order->id])).'','class' => 'text-xs']); ?><?php echo app('translator')->get('modules.order.newKot'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->waiter): ?>
                    <div class="inline-flex items-center text-gray-600 text-sm gap-1 ltr:pl-1 rtl:pr-1 dark:text-gray-400 flex-shrink-0">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->order_note): ?>
            <div class="w-full dark:border-gray-500 ">
                <div class="font-semibold text-gray-700 text-sm dark:text-gray-300 mb-2">
                    <?php echo app('translator')->get('modules.order.note'); ?>:
                   <span class="text-gray-600 text-sm dark:text-gray-400"> <?php echo e($order->order_note); ?></span>
                </div>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\components\order\order-card.blade.php ENDPATH**/ ?>