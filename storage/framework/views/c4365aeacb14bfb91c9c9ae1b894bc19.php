...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <?php echo app('translator')->get('landing.heroTitle'); ?></h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            <?php echo app('translator')->get('landing.heroSubTitle'); ?>
        </p>
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
            <a href="<?php echo e(route('restaurant_signup')); ?>"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trialPackage): ?>
                    <?php echo app('translator')->get('landing.startTrial', ['days' => $trialPackage->trial_days]); ?>
                <?php else: ?>
                    <?php echo app('translator')->get('landing.getStartedFree'); ?>
        ...
        <div class="relative  max-w-screen-lg flex justify-center mx-auto">
            <img src="<?php echo e(asset('landing/dashboard.png')); ?>" class="shadow-lg border rounded-lg" alt="">
            <!-- SVG Element -->
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto space-y-8">
    ...
    <div class="mx-auto mb-8 lg:mb-14 text-center">
        <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
            <?php echo app('translator')->get('landing.featureSection1'); ?>
        </h2>
    </div>
    <!-- End Title -->
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        <div>
            <img class="rounded-xl border border-gray-100 shadow" src="<?php echo e(asset('landing/order-management.png')); ?>"
            ...
            <div class="space-y-6 sm:space-y-8">
                ...
                <div class="space-y-2 md:space-y-4">
                    <h2 class="font-bold text-3xl lg:text-4xl text-gray-800 dark:text-neutral-200">
                        <?php echo app('translator')->get('landing.featureTitle1'); ?>
                    </h2>
                    <p class="text-gray-500 dark:text-neutral-500">
                        <?php echo app('translator')->get('landing.featureDescription1'); ?>
                    </p>
                </div>
                <!-- End Title -->
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        ...
        <div class="mt-5 sm:mt-10 lg:mt-0">
            <div class="space-y-6 sm:space-y-8">
                ...
                <div class="space-y-2 md:space-y-4">
                    <h2 class="font-bold text-3xl lg:text-4xl text-gray-800 dark:text-neutral-200">
                        <?php echo app('translator')->get('landing.featureTitle2'); ?>
                    </h2>
                    <p class="text-gray-500 dark:text-neutral-500">
                        <?php echo app('translator')->get('landing.featureDescription2'); ?>
                    </p>
                </div>
                <!-- End Title -->
        ...
        <!-- End Col -->
        <div>
            <img class="rounded-xl border border-gray-100 shadow" src="<?php echo e(asset('landing/table-reservation.png')); ?>"
                alt="order management">
        </div>
        <!-- End Col -->
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        <div>
            <img class="rounded-xl border border-gray-100 shadow" src="<?php echo e(asset('landing/menu-management.png')); ?>"
                alt="order management">
        </div>
        <!-- End Col -->
        ...
        <div class="mt-5 sm:mt-10 lg:mt-0">
            <div class="space-y-6 sm:space-y-8">
                ...
                <div class="space-y-2 md:space-y-4">
                    <h2 class="font-bold text-3xl lg:text-4xl text-gray-800 dark:text-neutral-200">
                        <?php echo app('translator')->get('landing.featureTitle3'); ?>
                    </h2>
                    <p class="text-gray-500 dark:text-neutral-500">
                        <?php echo app('translator')->get('landing.featureDescription3'); ?>
                    </p>
                </div>
                <!-- End Title -->
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="icon-features">
    ...
    <div class="mx-auto  mb-8 lg:mb-14 text-center">
        <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
            <?php echo app('translator')->get('landing.featureSection2'); ?>
        </h2>
    </div>
    <!-- End Title -->
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature1'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc1'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature2'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc2'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature3'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc3'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature4'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc4'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature5'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc5'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature6'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc6'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature7'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc7'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div>
            ...
            <div class="mt-5">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo app('translator')->get('landing.iconFeature8'); ?></h3>
                <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.iconFeatureDesc8'); ?></p>
            </div>
        </div>
        <!-- End Icon Block -->
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="mx-auto  mb-8 lg:mb-14 text-center">
        <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
            <?php echo app('translator')->get('landing.testimonialSection1'); ?>
        </h2>
    </div>
    <!-- End Title -->
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div
            ...
            <div class="flex-auto p-4 md:p-6">
                ...
                <p class="text-base text-gray-800 md:text-xl dark:text-white"><em>
                        " <?php echo app('translator')->get('landing.testimonial1'); ?> "
                    </em></p>
            </div>

            <div class="p-4 rounded-b-xl md:px-6">
                <h3 class="text-sm font-semibold text-gray-800 sm:text-base dark:text-neutral-200">
                    <?php echo app('translator')->get('landing.testimonialName1'); ?>
                </h3>
                <p class="text-sm text-gray-500 dark:text-neutral-500">
                    <?php echo app('translator')->get('landing.testimonialDesignation1'); ?>
                </p>
            </div>
        </div>
        <!-- End Card -->
        ...
        <div
            ...
            <div class="flex-auto p-4 md:p-6">
                ...
                <p class="text-base text-gray-800 md:text-xl dark:text-white"><em>
                        " <?php echo app('translator')->get('landing.testimonial2'); ?> "
                    </em></p>
            </div>

            <div class="p-4 rounded-b-xl md:px-6">
                <h3 class="text-sm font-semibold text-gray-800 sm:text-base dark:text-neutral-200">
                    <?php echo app('translator')->get('landing.testimonialName2'); ?>
                </h3>
                <p class="text-sm text-gray-500 dark:text-neutral-500">
                    <?php echo app('translator')->get('landing.testimonialDesignation2'); ?>
                </p>
            </div>
        </div>
        <!-- End Card -->
        ...
        <div
            ...
            <div class="flex-auto p-4 md:p-6">
                ...
                <p class="text-base text-gray-800 md:text-xl dark:text-white"><em>
                        " <?php echo app('translator')->get('landing.testimonial3'); ?> "
                    </em></p>
            </div>

            <div class="p-4 rounded-b-xl md:px-6">
                <h3 class="text-sm font-semibold text-gray-800 sm:text-base dark:text-neutral-200">
                    <?php echo app('translator')->get('landing.testimonialName3'); ?>
                </h3>
                <p class="text-sm text-gray-500 dark:text-neutral-500">
                    <?php echo app('translator')->get('landing.testimonialDesignation3'); ?>
                </p>
            </div>
        </div>
        <!-- End Card -->
...
<div class="overflow-hidden" id="simple-pricing">
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="mx-auto mb-8 lg:mb-14 text-center">
            <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
                <?php echo app('translator')->get('landing.pricingTitle1'); ?>
            </h2>
            <p class="my-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
                <?php echo app('translator')->get('landing.pricingSubTitle1'); ?>
            </p>
        </div>
        <!-- End Title -->
        <?php echo $__env->make('landing.pricing', ['packages' => $packages, 'modules' => $AllModulesWithFeature], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="user-faqs">
    ...
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white"><?php echo app('translator')->get('landing.faqTitle1'); ?></h2>
      <p class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo app('translator')->get('landing.faqSubTitle1'); ?></p>
    </div>
    <!-- End Title -->
        ...
        <div class="grid sm:grid-cols-2 gap-6 md:gap-12">
          <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
                <?php echo app('translator')->get('landing.faqQues1'); ?>
            </h3>
            <p class="mt-2 text-gray-600 dark:text-neutral-400">
                <?php echo app('translator')->get('landing.faqAns1'); ?>
            </p>
          </div>
          <!-- End Col -->
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
                <?php echo app('translator')->get('landing.faqQues2'); ?>
            </h3>
            <p class="mt-2 text-gray-600 dark:text-neutral-400">
                <?php echo app('translator')->get('landing.faqAns2'); ?>
            </p>
          </div>
          <!-- End Col -->
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
                <?php echo app('translator')->get('landing.faqQues3'); ?>
            </h3>
            <p class="mt-2 text-gray-600 dark:text-neutral-400">
                <?php echo app('translator')->get('landing.faqAns3'); ?>
            </p>
          </div>
          <!-- End Col -->
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
                <?php echo app('translator')->get('landing.faqQues4'); ?>
            </h3>
            <p class="mt-2 text-gray-600 dark:text-neutral-400">
                <?php echo app('translator')->get('landing.faqAns4'); ?>
            </p>
          </div>
          <!-- End Col -->
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
                <?php echo app('translator')->get('landing.faqQues5'); ?>
            </h3>
            <p class="mt-2 text-gray-600 dark:text-neutral-400">
                <?php echo app('translator')->get('landing.faqAns5'); ?>
            </p>
          </div>
          <!-- End Col -->
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
                <?php echo app('translator')->get('landing.faqQues6'); ?>
            </h3>
            <p class="mt-2 text-gray-600 dark:text-neutral-400">
                <?php echo app('translator')->get('landing.faqAns6'); ?>
            </p>
          </div>
          <!-- End Col -->
...
<div class="max-w-7xl px-4 lg:px-8 py-12 lg:py-24 mx-auto">
    <div class="mb-6 sm:mb-10 max-w-2xl text-center mx-auto">
      <h2 class="font-medium text-black text-2xl sm:text-4xl dark:text-white">
        <?php echo app('translator')->get('landing.contactTitle'); ?>
      </h2>
    </div>
      ...
      <div class="space-y-8 lg:space-y-16">
        <div>
          <h3 class="mb-5 font-semibold text-black dark:text-white">
            <?php echo app('translator')->get('landing.addressTitle'); ?>
          </h3>
          ...
          <div class="grid gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            <div class="flex gap-4">
              ...
              <div class="grow">
                <p class="text-sm text-gray-600 dark:text-neutral-400">
                    <?php echo app('translator')->get('landing.contactCompany'); ?>
                </p>
                <address class="mt-1 text-black not-italic dark:text-white">
                    <?php echo app('translator')->get('landing.contactAddress'); ?>
                </address>
              </div>
            </div>
            ...
            <div class="flex gap-4">
                ...
                <div class="grow">
                  <p class="text-sm text-gray-600 dark:text-neutral-400">
                    <?php echo app('translator')->get('landing.emailTitle'); ?>
                  </p>
                  <p>
                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-skin-base hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="mailto:<?php echo app('translator')->get('landing.contactEmail'); ?>">
                    <?php echo app('translator')->get('landing.contactEmail'); ?>
                    </a>
                  </p>
                </div>
              </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\landing\index.blade.php ENDPATH**/ ?>