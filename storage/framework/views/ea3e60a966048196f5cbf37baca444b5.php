<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($universalBundle): ?>
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-700 border-b border-gray-200 dark:border-gray-600 px-4 py-2.5">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <!-- Module Info -->
                    <div>
                        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100"><?php echo e($universalBundle->getName()); ?></h3>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config(strtolower($universalBundle->getName()) . '.setting')): ?>
                            <?php $envatoId = $plugins->where('envato_id', config(strtolower($universalBundle) . '.envato_item_id'))->first(); ?>
                            <div class="text-xs text-gray-600 dark:text-gray-400 mt-0.5">
                                <?php echo $__env->make('custom-modules.sections.version', ['module' => $universalBundle], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                ...
                <!-- Toggle Switch -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!config(strtolower($universalBundle->getName()) . '.name')): ?>
                    <div class="flex-shrink-0 relative"
                        ...
                        <label class="relative inline-flex items-center cursor-pointer group">
                            <input type="checkbox" class="sr-only peer change-module-status"
                                id="module-<?php echo e($universalBundle->getName()); ?>" data-module-name="<?php echo e($universalBundle->getName()); ?>">
                        ...
                        <div x-show="tooltip"
                             ...
                             role="tooltip">
                            <?php echo app('translator')->get('app.moduleSwitchMessage', ['name' => $universalBundle->getName()]); ?>
                        </div>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fetchSetting): ?>
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config(strtolower($universalBundle->getName()) . '.verification_required')): ?>
                            <?php echo $__env->make('custom-modules.sections.purchase-code', ['module' => $universalBundle->getName()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plugins->where('envato_id', config(strtolower($universalBundle->getName()) . '.envato_item_id'))->first()): ?>
                            <?php $envatoId = config(strtolower($universalBundle->getName()) . '.envato_item_id'); ?>
                            <?php echo $__env->make('custom-modules.sections.module-update', ['module' => $universalBundle, 'fetchSetting' => $fetchSetting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    <div class="flex flex-wrap items-center gap-1.5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fetchSetting?->license_type): ?>
                            <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">
                                ...
                                <?php echo e($fetchSetting->license_type); ?>

                            </span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains($fetchSetting->license_type, 'Regular')): ?>
                                <a href="<?php echo e(\Froiden\Envato\Helpers\FroidenApp::buyExtendedUrl(config(strtolower($universalBundle->getName()) . '.envato_item_id'))); ?>"
                                    target="_blank"
                    ...
                    <!-- Support Date Info -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fetchSetting?->purchase_code && $fetchSetting?->supported_until): ?>
                        <div class="flex items-center text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/50 rounded-md px-2.5 py-1.5 border border-gray-200 dark:border-gray-600">
                            ...
                            <span><?php echo $__env->make('custom-modules.sections.support-date', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
    ...
    <?php if ($__env->exists('universalbundle::install-modules')) echo $__env->make('universalbundle::install-modules', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\custom-modules\sections\universal-bundle.blade.php ENDPATH**/ ?>