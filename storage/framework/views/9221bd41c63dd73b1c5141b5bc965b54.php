...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['id', 'note' => '']));
...
foreach (array_filter((['id', 'note' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="{
    ...
    noteText: '<?php echo e($note); ?>',
    showNoteIcon: <?php echo e(strlen($note) > 0 ? 'true' : 'false'); ?>,
    saveNote() {
        $wire.updateItemNote('<?php echo e($id); ?>', this.noteText);
    ...
    <div x-show="showNoteIcon && !showNoteInput && !showNotePreview" x-cloak
        ...
        @click="showPreview()"
        title="<?php echo app('translator')->get('modules.order.specialInstructions'); ?>">
        ...
        <span class="truncate max-w-[70px] md:max-w-64 lg:max-w-[70px]"><?php echo e($note); ?></span>
    </div>
    ...
    <button
        ...
        title="<?php echo app('translator')->get('modules.order.addNote'); ?>">
    ...
    <div
        ...
        <div class="bg-white dark:bg-gray-700 rounded-md shadow-md border border-gray-300 dark:border-gray-600 p-3 w-64 md:w-96">
            <div class="text-sm dark:text-white mb-2 break-all"><?php echo e($note); ?></div>
        ...
        <div class="relative">
            <div class="flex items-center bg-white dark:bg-gray-700 rounded-md shadow-md border border-gray-300 dark:border-gray-600 overflow-hidden">
                <input
                    ...
                    placeholder="<?php echo e(__('placeholders.addItemNotesPlaceholder')); ?>"
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\components\pos\item-note.blade.php ENDPATH**/ ?>