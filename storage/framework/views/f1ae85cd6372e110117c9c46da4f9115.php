...
<head>
    ...
    <title><?php echo e(__('errors.325.title')); ?></title>
        ...
        <div class="w-full max-w-lg space-y-8">
            ...
            <div class="text-center">
                <h2 class="mt-6 text-3xl font-extrabold tracking-tight theme-transition"
                    ...
                    <?php echo e(__('errors.325.title')); ?>

                </h2>
                <p class="mt-2 text-sm theme-transition"
                   :class="darkMode ? 'text-gray-400' : 'text-gray-600'">
                    <?php echo e(__('errors.325.message')); ?>

                </p>
                <p class="mt-2 text-sm theme-transition"
                   :class="darkMode ? 'text-gray-400' : 'text-gray-600'">
                    <?php echo e(__('errors.325.suggestion')); ?>
            ...
            <div class="mt-8 space-y-4">
                <a href="<?php echo e(route('restaurant_signup')); ?>"
                   ...
                   :class="darkMode ? 'bg-purple-600 hover:bg-purple-500' : 'bg-indigo-600 hover:bg-indigo-500'">
                    ...
                    <?php echo e(__('errors.325.create_account')); ?>

                </a>

                <a href="<?php echo e(route('front.forgot-restaurant')); ?>"
                   ...
                   :class="darkMode ? 'bg-gray-700 text-white hover:bg-gray-600 border-gray-600' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-300'">
                    ...
                    <?php echo e(__('errors.325.find_url')); ?>
            ...
            <div class="mt-8 text-center text-sm theme-transition"
                 :class="darkMode ? 'text-gray-400' : 'text-gray-600'">
                <p><?php echo e(__('errors.325.need_help')); ?></p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\errors\325.blade.php ENDPATH**/ ?>