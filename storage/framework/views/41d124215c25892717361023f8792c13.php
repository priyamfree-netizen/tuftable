...
<div>
    ...
    <div class="px-4 mb-4">
        <h3 class="mb-4 text-xl font-semibold dark:text-white"><?php echo app('translator')->get('modules.settings.cancelSettings'); ?></h3>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => 'showAddKotReason']); ?><?php echo app('translator')->get('app.add'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col"
                                    class="py-2.5 px-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <?php echo app('translator')->get('modules.settings.cancellationTypes'); ?>
                                </th>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='reason-<?php echo e($reason->id . rand(1111, 9999) . microtime()); ?>' wire:loading.class.delay='opacity-10'>
                                ...
                                <td class="py-2.5 px-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center gap-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reason->cancel_order): ?>
                                            <span class="inline-flex items-center px-2 py-1 text-xs font-medium text-red-800 bg-red-100 rounded-full dark:bg-red-900 dark:text-red-300">
                                                <?php echo app('translator')->get('modules.order.order'); ?>
                                            </span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reason->cancel_kot): ?>
                                ...
                                <td class="py-2.5 px-4 space-x-2 whitespace-nowrap text-right">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strtolower($reason->reason) === 'other'): ?>
                                        <span class="inline-flex items-center px-3 py-1 text-xs font-medium text-gray-600 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                                            <?php echo app('translator')->get('modules.settings.default'); ?>
                                        </span>
                                    <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.right-modal','data' => ['wire:model.live' => 'showAddCancelReasonModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showAddCancelReasonModal']); ?>
 <?php $__env->slot('title', null, []); ?> 
<?php echo e(__("modules.settings.addKotCancelReason")); ?>
...
[$__name, $__params] = $__split('forms.AddKotCancelReason');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1442202417-0', null);
...
<?php if (isset($component)) { $__componentOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.right-modal','data' => ['wire:model.live' => 'showEditCancelReasonModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('right-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showEditCancelReasonModal']); ?>
 <?php $__env->slot('title', null, []); ?> 
<?php echo e(__("modules.settings.editKotCancelReason")); ?>
...
[$__name, $__params] = $__split('forms.EditKotCancelReason', ['kotCancelReason' => $reasonToEdit]);

$key = $reasonToEdit->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1442202417-1', $reasonToEdit->id);
...
<?php $component->withAttributes(['wire:model.defer' => 'showDeleteModal']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <?php echo app('translator')->get('modules.settings.deleteCancelReasonWarning'); ?>
         <?php $__env->endSlot(); ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\settings\cancellation-settings.blade.php ENDPATH**/ ?>