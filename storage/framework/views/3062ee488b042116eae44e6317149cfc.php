<div>
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        <div class="mb-6">
            <h2 class="text-2xl font-semibold text-gray-900 dark:text-white mb-2"><?php echo app('translator')->get('modules.menu.exportMenuItems'); ?></h2>
            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo app('translator')->get('modules.menu.exportMenuItemsHelp'); ?></p>
        </div>
            ...
            <div class="flex items-start justify-between mb-4">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                        ...
                        <?php echo app('translator')->get('modules.menu.quickExport'); ?>
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo app('translator')->get('modules.menu.quickExportDescription'); ?></p>
                </div>
            </div>

            <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['target' => 'quickExport'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'quickExport','type' => 'button']); ?>
                ...
                <span wire:loading.remove wire:target="quickExport"><?php echo app('translator')->get('modules.menu.exportAllCSV'); ?></span>
                <span wire:loading wire:target="quickExport"><?php echo app('translator')->get('app.exporting'); ?>...</span>
        ...
        <div class="mb-6">
            ...
            >
                <div class="flex items-center gap-x-2.5">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.menu.advancedExport'); ?></h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo app('translator')->get('modules.menu.advancedExportDescription'); ?></p>
                    </div>
                </div>
                <svg class="w-5 h-5 transition-transform text-gray-800 dark:text-white <?php echo e($showAdvancedExport ? 'rotate-180' : ''); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 9-7 7-7-7"/></svg>
            </button>
        </div>

        <!-- Advanced Export Form -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showAdvancedExport): ?>
            <div class="p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 space-y-6">
                <!-- Format Selection -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo app('translator')->get('modules.menu.exportFormat'); ?></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Category Filter -->
                    <div>
                        <label for="category_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo app('translator')->get('modules.menu.itemCategory'); ?></label>
                    ...
                    <div>
                        <label for="menu_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo app('translator')->get('modules.menu.menuName'); ?></label>
                    ...
                    <!-- Status Filter -->
                    <div>
                        <label for="status" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo app('translator')->get('modules.menu.status'); ?></label>
                    ...
                    <!-- Type Filter -->
                    <div>
                        <label for="type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo app('translator')->get('modules.menu.itemType'); ?></label>
                        <select wire:model.live="type" id="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                            <option value=""><?php echo app('translator')->get('app.all'); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </select>
                    </div>
                    ...
                    <!-- Start Date -->
                    <div>
                        <label for="start_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo app('translator')->get('app.startDate'); ?></label>
                    ...
                    <!-- End Date -->
                    <div>
                        <label for="end_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo app('translator')->get('app.endDate'); ?></label>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recordCount > 0): ?>
                    <div class="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                        <p class="text-sm text-blue-800 dark:text-blue-300">
                            ...
                            <strong><?php echo e($recordCount); ?></strong> <?php echo e(Str::plural('record', $recordCount)); ?> will be exported.
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recordCount > 5000): ?>
                                <span class="block mt-1"><?php echo app('translator')->get('messages.largeExportQueued'); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'resetFilters','type' => 'button']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'resetFilters','type' => 'button']); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['target' => 'advancedExport'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'advancedExport','type' => 'button']); ?>
                        ...
                        <span wire:loading.remove wire:target="advancedExport"><?php echo app('translator')->get('app.export'); ?></span>
                        <span wire:loading wire:target="advancedExport"><?php echo app('translator')->get('app.exporting'); ?>...</span>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\menu\export-menu-items.blade.php ENDPATH**/ ?>