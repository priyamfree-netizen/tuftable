...
<div class="max-w-3xl px-4 py-16 mx-auto">
    <div class="mb-12 text-center">
        <h2 class="font-bold text-black text-3xl sm:text-4xl dark:text-white">
            <?php echo e(__('landing.contactTitle')); ?>
            ...
            <div class="space-y-12">
                ...
                <div class="group">
                    <h3 class="mb-6 text-xl font-semibold text-black dark:text-white flex items-center gap-3">
                        ...
                        <?php echo e(__('landing.addressTitle')); ?>
                ...
                <div class="grid sm:grid-cols-2 gap-8">
                    ...
                    <div class="group">
                        <h3 class="mb-4 text-xl font-semibold text-black dark:text-white flex items-center gap-3">
                            ...
                            <?php echo e(__('landing.emailTitle')); ?>

                        </h3>
                        <a class="text-gray-600 dark:text-gray-400 hover:text-skin-base dark:hover:text-skin-base transition-colors pl-12 flex items-center gap-2" href="mailto:<?php echo e($restaurant->email); ?>">
                    ...
                    <div class="group">
                        <h3 class="mb-4 text-xl font-semibold text-black dark:text-white flex items-center gap-3">
                            ...
                            <?php echo e(__('landing.callTitle')); ?>

                        </h3>
                        <a class="text-gray-600 dark:text-gray-400 hover:text-skin-base dark:hover:text-skin-base transition-colors pl-12 flex items-center gap-2" href="tel:<?php echo e($restaurant->phone_number); ?>">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\shop\contact.blade.php ENDPATH**/ ?>