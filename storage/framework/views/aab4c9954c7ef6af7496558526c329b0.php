...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'reason','class' => 'block mt-1 w-full','type' => 'text','wire:model' => 'reason']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reason','class' => 'block mt-1 w-full','type' => 'text','wire:model' => 'reason']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <div class="space-y-3">
                    <label class="flex items-center">
                        <input type="checkbox" wire:model.defer="cancel_order" class="w-4 h-4 bg-gray-100 rounded border-gray-300 text-skin-base focus:ring-skin-base dark:focus:ring-skin-base dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if($cancel_order): echo 'checked'; endif; ?>>
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" wire:model.defer="cancel_kot" class="w-4 h-4 bg-gray-100 rounded border-gray-300 text-skin-base focus:ring-skin-base dark:focus:ring-skin-base dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if($cancel_kot): echo 'checked'; endif; ?>>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$dispatch(\'hideEditKotReason\')','wire:loading.attr' => 'disabled']); ?><?php echo app('translator')->get('app.cancel'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\forms\edit-kot-cancel-reason.blade.php ENDPATH**/ ?>