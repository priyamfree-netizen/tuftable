      ...
      <script>
        ...
        async function saveToServer(dataUrl, actualWidth) {
          ...
          const res = await fetch(
            "<?php echo e(route('kot.png.store')); ?>", {
            method: 'POST',
            headers: {'Content-Type':'application/json','X-CSRF-TOKEN': csrf},
            body: JSON.stringify({
              image_base64: dataUrl,
              kot_id: <?php echo e($kot->id); ?>,
        ...
        window.addEventListener('load', async () => {
          ...
          try {
            console.log('Starting KOT image capture for KOT ID: <?php echo e($kot->id); ?>');
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\capture-kot.blade.php ENDPATH**/ ?>