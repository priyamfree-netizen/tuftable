...
<div class="payment_methods">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showOnline && $paymentGatewayActive): ?>
        <div class="grid items-baseline grid-cols-1 gap-4 space-y-4 md:grid-cols-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->stripe_status === 1): ?>
                <button wire:click="initiateStripePayment(<?php echo e($selectedPlan?->id); ?>)" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->razorpay_status === 1): ?>
                <button wire:click="razorpaySubscription(<?php echo e($selectedPlan?->id); ?>);" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->flutterwave_status === 1): ?>
                <button wire:click="initiateFlutterwavePayment(<?php echo e($selectedPlan?->id); ?>);" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->paypal_status === 1): ?>
                <button wire:click="initiatePaypalPayment(<?php echo e($selectedPlan?->id); ?>);" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->payfast_status === 1): ?>
                <button wire:click="initiatePayfastPayment(<?php echo e($selectedPlan?->id); ?>);" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->paystack_status === 1): ?>
                <button wire:click="initiatePaystackPayment(<?php echo e($selectedPlan?->id); ?>);" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->xendit_status === 1): ?>
                <button wire:click="initiateXenditPayment(<?php echo e($selectedPlan?->id); ?>);" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->paddle_status === 1): ?>
                <button
                    wire:click="initiatePaddlePayment(<?php echo e($selectedPlan?->id); ?>);"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->mollie_status === 1): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stripeSettings->tap_status === 1): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($offlinePaymentGateways > 0): ?>
                <button wire:click="togglePaymentOptions('0')" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn gap-x-1">
                    ...
                    <?php echo app('translator')->get('modules.billing.payOffline'); ?>
                </button>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$showOnline && $offlinePaymentGateways > 0): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGatewayActive): ?>
            <button wire:click="togglePaymentOptions('1')" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 f-15 btn gap-x-1">
                ...
                <?php echo app('translator')->get('modules.billing.payOnline'); ?>
            </button>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <div class="grid grid-cols-1 gap-6 mt-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="relative flex flex-col gap-4 px-4 py-3 text-gray-700 transition bg-white border border-gray-200 rounded-md shadow dark:bg-gray-700 hover:border-bg-indigo-300 hover:bg-indigo-50 dark:hover:bg-gray-600 focus-within:ring-2 focus-within:ring-indigo-500 peer-checked:border-indigo-500 peer-checked:bg-indigo-100 dark:peer-checked:text-indigo-900">
                    <span class="text-lg font-medium dark:text-gray-300"><?php echo e($method->name); ?></span>
                    <input type="radio" name="PaymentOption" wire:model.live="offlineMethodId" value="<?php echo e($method->id); ?>" class="absolute inset-0 z-10 opacity-0 cursor-pointer peer"/>
                    ...
                    <div class="text-xs text-gray-400">
                        <?php echo nl2br(e($method->description)); ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\plans\payment-methods.blade.php ENDPATH**/ ?>