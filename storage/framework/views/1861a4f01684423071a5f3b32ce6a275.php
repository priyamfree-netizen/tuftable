        ...
        <header class="lg:hidden">
            <nav class="bg-white border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:text-gray">
                <div class="flex flex-wrap justify-between items-center mx-auto">
                    <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-1 app-logo">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(global_setting()->show_logo_text): ?>
                            <span
                                class="self-center text-xl font-semibold whitespace-nowrap dark:text-white"><?php echo e(global_setting()->name); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </a>
                        ...
                        <ul class="flex flex-col font-medium ">
                            <li>
                                <a href="<?php echo e(url('/')); ?>"
                                    class="block py-2 pr-4 pl-3 text-gray-700 rounded dark:text-white"><?php echo app('translator')->get('menu.home'); ?></a>
                            </li>

                            <li>
                                <a href="<?php echo e(url('/')); ?>#icon-features"
                                    class="block py-2 pr-4 pl-3 text-gray-700 rounded dark:text-white"><?php echo app('translator')->get('landing.features'); ?></a>
                            </li>

                            <li>
                                <a href="<?php echo e(url('/')); ?>#simple-pricing"
                                    class="block py-2 pr-4 pl-3 text-gray-700 rounded dark:text-white"><?php echo app('translator')->get('landing.pricing'); ?></a>
                            </li>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $customMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($menu->is_active && $menu->position == 'header'): ?>
                                    <li>
                                        <a href="<?php echo e(route('customMenu', ['slug' => $menu->menu_slug])); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <li>
                                <a href="<?php echo e(route('restaurant_signup')); ?>" wire:navigate
                                    class="block py-2 pr-4 pl-3 text-gray-700 rounded dark:text-white"><?php echo app('translator')->get('landing.getStarted'); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1"
                        ...
                        <ul
                            ...
                            <li>
                                <a href="<?php echo e(url('/')); ?>" wire:navigate class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <li>
                                <a href="<?php echo e(url('/')); ?>#icon-features" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    'transition-all duration-300 block py-2 pr-4 pl-3 rounded lg:bg-transparent lg:p-0 text-gray-700 dark:text-white',
                                ]); ?>"
                                    aria-current="page"><?php echo app('translator')->get('landing.features'); ?></a>
                            </li>

                            <li>
                                <a href="<?php echo e(url('/')); ?>#simple-pricing" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    'transition-all duration-300 block py-2 pr-4 pl-3 rounded lg:bg-transparent lg:p-0 text-gray-700 dark:text-white',
                                ]); ?>"
                                    aria-current="page"><?php echo app('translator')->get('landing.pricing'); ?></a>
                            </li>

                            <li>
                                <a href="<?php echo e(url('/')); ?>#user-faqs" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    'transition-all duration-300 block py-2 pr-4 pl-3 rounded lg:bg-transparent lg:p-0 text-gray-700 dark:text-white',
                                ]); ?>"
                                    aria-current="page"><?php echo app('translator')->get('landing.faq'); ?></a>
                            </li>
    ...
    <footer class="p-4 bg-white sm:p-6 dark:bg-gray-800 border-t dark:border-gray-600">
        <div class="mx-auto max-w-screen-xl">
            <div class="sm:flex sm:items-center sm:justify-between flex-wrap gap-4">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© <?php echo e(now()->year); ?> <a
                        href="" class="hover:underline"><?php echo e(global_setting()->name); ?></a>. <?php echo app('translator')->get('landing.rightsReserved'); ?>
                </span>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2343764720-0', null);
...
?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(global_setting()->facebook_link): ?>
                        <a href="<?php echo e(global_setting()->facebook_link); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(global_setting()->instagram_link): ?>
                        <a href="<?php echo e(global_setting()->instagram_link); ?>"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(global_setting()->twitter_link): ?>
                        <a href="<?php echo e(global_setting()->twitter_link); ?>"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(global_setting()->yelp_link): ?>
                        <a href="<?php echo e(global_setting()->yelp_link); ?>"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\layouts\landing.blade.php ENDPATH**/ ?>