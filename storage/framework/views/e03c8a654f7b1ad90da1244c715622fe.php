...
<div class="space-y-6 mb-10">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($allModules) > 0): ?>
    <div class="flex mb-4">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-link','data' => ['href' => ''.e(route('superadmin.custom-modules.create')).'','class' => 'inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('superadmin.custom-modules.create')).'','class' => 'inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase']); ?>
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
            </svg> <?php echo app('translator')->get('app.moduleSettingsInstall'); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('subdomain_module_activated') == 'activated'): ?>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-3 bg-white p-3 rounded border border-blue-100 dark:bg-gray-800 dark:text-white">
                    <div class="flex-grow">
                        ...
                        <code class="ml-2 bg-gray-50 px-2 py-1 rounded text-sm dark:bg-gray-200 dark:text-black"><?php echo e(url('/')); ?>/super-admin-login</code>
                    </div>
                    <button class="copy-url p-2 hover:bg-gray-100 rounded dark:text-black dark:bg-gray-800 data-url="<?php echo e(url('/')); ?>/super-admin-login">
    ...
    <?php if ($__env->exists('languagepack::module-activated-alert')) echo $__env->make('languagepack::module-activated-alert', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('custom-modules.sections.universal-bundle', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$universalBundle): ?>
    <!-- License Status Legend -->
    <div class="bg-white rounded-lg border p-4 mb-4 dark:bg-gray-800">
        <div class="flex items-center justify-between">
            <h3 class="text-sm font-medium text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.moduleLicenseStatus.moduleLicenseStatus'); ?></h3>
            <div class="flex items-center space-x-4 text-xs">
                <div class="flex items-center space-x-1">
                    <div class="w-3 h-3 bg-green-400 rounded"></div>
                    <span class="text-gray-600 dark:text-gray-300"><?php echo app('translator')->get('modules.moduleLicenseStatus.licensed'); ?></span>
                </div>
                <div class="flex items-center space-x-1">
                    <div class="w-3 h-3 bg-yellow-400 rounded"></div>
                    <span class="text-gray-600 dark:text-gray-300"><?php echo app('translator')->get('modules.moduleLicenseStatus.verificationRequired'); ?></span>
                </div>
                <div class="flex items-center space-x-1">
                    <div class="w-3 h-3 bg-gray-400 rounded"></div>
                    <span class="text-gray-600 dark:text-gray-300"><?php echo app('translator')->get('modules.moduleLicenseStatus.notActivated'); ?></span>
                </div>
            </div>
        </div>
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['class' => 'custom-modules-table dark:bg-gray-800 min-w-full','headType' => 'bg-gray-50','id' => 'custom-modules-table']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'custom-modules-table dark:bg-gray-800 min-w-full','headType' => 'bg-gray-50','id' => 'custom-modules-table']); ?>
             <?php $__env->slot('thead', null, ['class' => 'dark:bg-gray-800']); ?> 
                <th class="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap"><?php echo app('translator')->get('app.name'); ?></th>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$universalBundle): ?>
                    <th class="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap"><?php echo app('translator')->get('app.purchaseCode'); ?></th>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <th class="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap"><?php echo app('translator')->get('app.moduleVersion'); ?></th>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$universalBundle): ?>
                    <th class="px-3 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap"><?php echo app('translator')->get('app.notify'); ?></th>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <th class="px-3 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap"><?php echo app('translator')->get('app.status'); ?></th>
             <?php $__env->endSlot(); ?>
                ...
                <tr class="<?php echo e($rowClass); ?>">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm">
                        <div class="flex items-center space-x-3">
                            <!-- Status Icon -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($isInstalled && $isLicensed) || ($universalBundle && $isInstalled)): ?>
                                <div class="flex-shrink-0">
                                    <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                </div>
                            <?php elseif($isInstalled && !$isLicensed): ?>
                                <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow">
                                <div class="flex items-center space-x-2">
                                    <div class="flex flex-col">
                                        <span class="text-gray-900 font-bold font-semibold"><?php echo e($module); ?>


                                             <!-- License Status Badge -->
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isInstalled && $isLicensed): ?>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_enabled('UniversalBundle') && isInstallFromUniversalBundleModule($module)): ?>
                                            <span class="ml-1 text-blue-500 cursor-pointer group relative">
                                                ...
                                                <span class="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-max max-w-xs px-2 py-1 rounded bg-gray-900 text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-20 whitespace-pre-line">
                                                    <?php echo e(__('universalbundle::app.moduleInfo')); ?>

                                                </span>
                                            </span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                <?php elseif($isInstalled && !$isLicensed && $verificationRequired &&  !$universalBundle): ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                        ⚠ <?php echo app('translator')->get('modules.moduleLicenseStatus.verificationRequired'); ?>
                                    </span>
                                <?php elseif(!$isInstalled): ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600">
                                        🔒 <?php echo app('translator')->get('modules.moduleLicenseStatus.notActivated'); ?>
                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fetchSetting && $fetchSetting->supported_until && !$universalBundle): ?>
                                            <?php
                                            ...
                                            <div class="flex items-center space-x-2  mt-1">
                                                <div class="flex items-center px-0.5  rounded text-[10px]
                                                    <?php echo e($isExpired ? 'bg-red-50 border border-red-200' : ($daysRemaining < 30 ? 'bg-yellow-50 border border-yellow-200' : 'bg-blue-50 border border-blue-200')); ?>">

                                                    <span class="text-[10px] mx-0.5
                                                        <?php echo e($isExpired ? 'text-red-700' : ($daysRemaining < 30 ? 'text-yellow-700' : 'text-blue-700')); ?>">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isExpired): ?>
                                                            <?php echo app('translator')->get('modules.moduleLicenseStatus.supportExpired'); ?>:
                                                            <b><?php echo e($supportDate->format('j')); ?><sup><?php echo e($supportDate->format('S')); ?></sup> <?php echo e($supportDate->format('M, Y')); ?></b>
                                                            ...
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php else: ?>
                                                            <?php echo app('translator')->get('modules.moduleLicenseStatus.supportUntil'); ?>:
                                                            <b><?php echo e($supportDate->format('j')); ?><sup><?php echo e($supportDate->format('S')); ?></sup> <?php echo e($supportDate->format('M, Y')); ?></b>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_enabled('UniversalBundle') && isInstallFromUniversalBundleModule($key)): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$universalBundle): ?>
                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm ">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fetchSetting): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($verificationRequired): ?>
                                    <?php echo $__env->make('custom-modules.sections.purchase-code', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settingClass): ?>
                            <?php echo $__env->make('custom-modules.sections.version', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plugins->where('envato_id', $envatoId)->first() && !(module_enabled('UniversalBundle') && !isInstallFromUniversalBundleModule($key))): ?>
                                <?php echo $__env->make('custom-modules.sections.module-update', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    ...
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-right text-sm">
                        ...
                        <div class="inline-block ml-2 group relative">
                            ...
                            <div class="pointer-events-none hidden group-hover:block absolute z-50 w-75 px-4 py-2
                                ...
                                <?php echo app('translator')->get('app.moduleNotifySwitchMessage', ['name' => $module]); ?>
                            </div>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    ...
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-right text-sm">
                        <div class="flex items-center justify-end space-x-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isInstalled || !$isLicensed): ?>
                                ...
                                ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($availableModule): ?>
                                    <a href="<?php echo e($availableModule['product_link']); ?>" target="_blank"
                                       class="inline-flex items-center px-2 py-1 border border-transparent text-xs font-medium rounded text-white <?php echo e(!$isInstalled ? 'bg-red-600 hover:bg-red-700' : 'bg-orange-600 hover:bg-orange-700'); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isInstalled): ?>
                            ...
                            <div class="inline-block group relative" data-toggle="tooltip"
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" <?php if(in_array($key, custom_module_plugins())): ?> checked <?php endif; ?>
                                        class="sr-only peer change-module-status <?php echo e(!$verificationRequired && $isInstalled ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                        ...
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full
                                                ...
                                                <?php echo e($isLicensed || $universalBundle ? 'peer-checked:bg-green-600' : 'peer-checked:bg-yellow-500'); ?>">
                                        </div>
                                </label>
                                ...
                                <div class="pointer-events-none hidden group-hover:block absolute z-50 w-75 px-4 py-2
                                        ...
                                        <?php echo app('translator')->get('app.moduleSwitchMessage', ['name' => $module]); ?>
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                    <td colspan="5" class="px-3 sm:px-6 py-4 text-center">
                        <div class="flex flex-col items-center justify-center space-y-4">
                            ...
                            <span class="text-sm text-gray-500"><?php echo app('translator')->get('messages.noRecordFound'); ?></span>
                            <p class="text-sm text-gray-600"><?php echo app('translator')->get('messages.moduleSettingsInstall'); ?></p>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('vendor.froiden-envato.update.plugins', ['allModules' => $allModules], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<script>
    ...
    function updateModuleStatus(module, moduleStatus) {
        let url = "<?php echo e(route('superadmin.custom-modules.update', ':module')); ?>";
...
<script src="<?php echo e(asset('vendor/froiden-helper/helper.js')); ?>"></script>
...
<script>
    ...
    $('body').on('click', '.verify-module', function () {
        ...
        let url = "<?php echo e(route('superadmin.custom-modules.show', ':module')); ?>";
        url = url.replace(':module', module);
        $.easyAjax({
            url: url,
...
<?php if ($__env->exists('vendor.froiden-envato.update.update_module')) echo $__env->make('vendor.froiden-envato.update.update_module', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\custom-modules\ajax\custom.blade.php ENDPATH**/ ?>