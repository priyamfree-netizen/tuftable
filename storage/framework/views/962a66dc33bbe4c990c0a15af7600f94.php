    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg m-4">
        <header class="border-b border-gray-200 dark:border-gray-600 py-4">
            <div class="flex flex-col items-start gap-1 px-3 md:px-6">
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.menu.editMenuItem'); ?></h1>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo app('translator')->get('modules.menu.editMenuItemHelp'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('forms.updateMenuItem', ['menuItemId' => $menuItemId]);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3557772004-0', null);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\menu_items\edit.blade.php ENDPATH**/ ?>