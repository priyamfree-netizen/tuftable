<div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-900 dark:border-gray-700 dark:shadow-gray-700/70 p-3 space-y-3 min-h-0">
    <div class="flex flex-col sm:flex-row sm:justify-between gap-2">
        <div class="text-base font-semibold text-gray-800 dark:text-white flex items-center gap-2 flex-wrap">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($reservation->table_id)): ?>
            <div class="flex items-center gap-2">
                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['p-2 rounded-md tracking-wide', 'bg-skin-base/[0.2] text-skin-base' => (!is_null($reservation->table_id)), 'bg-yellow-200 text-yellow-800' => (is_null($reservation->table_id))]); ?>">
                    <h3 wire:loading.class.delay='opacity-50'
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses(['font-semibold']); ?>">
                        <?php echo e($reservation->table->table_code); ?>

                    </h3>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Update Reservation')): ?>
                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'changeTable('.e($reservation->id).')','wire:key' => 'reservation-table-change-'.e($reservation->id).'','class' => 'text-xs px-0.5 py-0.5 rounded']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'changeTable('.e($reservation->id).')','wire:key' => 'reservation-table-change-'.e($reservation->id).'','class' => 'text-xs px-0.5 py-0.5 rounded']); ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_null($reservation->table_id) && user_can('Update Reservation')): ?>
            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'assignTable('.e($reservation->id).')','wire:key' => 'reservation-table-assign-'.e($reservation->id).'','class' => 'text-xs sm:text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'assignTable('.e($reservation->id).')','wire:key' => 'reservation-table-assign-'.e($reservation->id).'','class' => 'text-xs sm:text-sm']); ?>
...
<?php endif; ?>
        ...
        <span class="<?php echo \Illuminate\Support\Arr::toCssClasses(['inline-flex items-center text-xs font-medium px-2 py-1 rounded uppercase tracking-wide whitespace-nowrap ',
            ...
            <?php echo app('translator')->get('modules.reservation.' . $reservation->reservation_status); ?>
        ...
        <div class="text-gray-700 dark:text-gray-400 flex flex-col space-y-1 sm:space-y-2 text-right">
            <div class="flex gap-2 justify-end text-xs sm:text-sm font-medium">
                <?php echo e($reservation->party_size); ?> <?php echo app('translator')->get('modules.reservation.guests'); ?>
            </div>
            ...
            <div class="inline-flex gap-2 items-center text-xs sm:text-sm font-medium text-skin-base justify-end">
                ...
                <span class="text-xs sm:text-sm"><?php echo e($reservation->reservation_date_time->format(dateFormat() . ' ' . timeFormat())); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 p-2 sm:p-3 bg-gray-100 rounded-md dark:bg-gray-700 dark:text-gray-300">
        <div class="text-xs inline-flex items-center gap-1">
            ...
            <span class="truncate"><?php echo e($reservation->customer->name); ?></span>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($reservation->customer->email)): ?>
        <div class="text-xs flex items-center gap-1 justify-end">
            ...
            <span class="truncate"><?php echo e($reservation->customer->email); ?></span>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($reservation->customer->phone)): ?>
        <div class="text-xs inline-flex items-center gap-1">
            ...
            <span class="truncate"><?php echo e($reservation->customer->phone); ?></span>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($reservation->special_requests)): ?>
    <div class="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400 p-2">
        ...
        <span class="truncate"><?php echo e($reservation->special_requests); ?></span>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['wire:model.live' => 'reservationStatus','class' => 'w-full sm:text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'reservationStatus','class' => 'w-full sm:text-sm']); ?>
                <option value="Confirmed"><?php echo app('translator')->get('modules.reservation.Confirmed'); ?></option>
                <option value="Checked_In"><?php echo app('translator')->get('modules.reservation.Checked_In'); ?></option>
                <option value="Cancelled"><?php echo app('translator')->get('modules.reservation.Cancelled'); ?></option>
                <option value="No_Show"><?php echo app('translator')->get('modules.reservation.No_Show'); ?></option>
                <option value="Pending"><?php echo app('translator')->get('modules.reservation.Pending'); ?></option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tableReservation): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'showTableModal','maxWidth' => '2xl']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tableReservation->table_id): ?>
                <?php echo app('translator')->get('modules.reservation.changeTable'); ?>
            <?php else: ?>
...
[$__name, $__params] = $__split('reservations.assignTable', ['reservation' => $tableReservation]);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1772872643-0', null);
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\reservations\reservation-card.blade.php ENDPATH**/ ?>