...
<?php $component->withAttributes([]); ?>
    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('app.forgotPasswordMessage')); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between mt-4">
                <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                    ← <?php echo e(__('app.backToLogin')); ?>
...
<?php $component->withAttributes(['class' => 'button']); ?>
                    <?php echo e(__('app.sendPasswordResetLink')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>