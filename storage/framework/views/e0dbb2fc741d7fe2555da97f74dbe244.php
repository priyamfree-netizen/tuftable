        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <h1
                class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                    <?php echo e($frontDetails->header_title ?? __('landing.heroTitle')); ?>

                </h1>
            <div class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                <?php echo $frontDetails->header_description ?? __('landing.heroSubTitle'); ?>
            ...
            <div class="relative  max-w-screen-lg flex justify-center mx-auto">
                ...
                <div>
                    <img src="<?php echo e($frontDetails->image_url ?? asset('landing/dashboard.png')); ?>" class="shadow-lg border rounded-lg " alt="">
                </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Priyam\Videos\tuftable\resources\views/landing/dynamic-index.blade.php ENDPATH**/ ?>