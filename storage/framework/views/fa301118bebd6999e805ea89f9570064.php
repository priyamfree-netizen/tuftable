                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div class="min-w-0">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-1 truncate">
                            <?php echo e($selectionStage === 'order_type' ? __('modules.order.selectOrderType') : __('modules.order.selectDeliveryPlatform')); ?>

                        </h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            <?php echo e($selectionStage === 'order_type' ? __('modules.order.selectOrderTypeDescription') : __('modules.order.selectDeliveryPlatformDescription')); ?>

                        </p>
                    </div>
                    <div class="flex items-center gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectionStage === 'delivery_platform'): ?>
                            <button type="button" wire:click="goBackToOrderTypes" class="p-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg transition-all" title="<?php echo app('translator')->get('modules.order.backToOrderTypes'); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                                </svg>
                            </button>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedOrderTypeSlug): ?>
                            <button type="button" wire:click="resetSelection" class="p-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg transition-all" title="<?php echo app('translator')->get('modules.order.resetSelection'); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 p-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg transition-all" title="<?php echo app('translator')->get('menu.dashboard'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center gap-2 p-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg transition-all" title="<?php echo app('translator')->get('modules.order.closeModal'); ?>">
                            ...
                            <?php echo app('translator')->get('menu.orders'); ?>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50/70 dark:bg-gray-800/60 px-4 py-3 shadow-sm">
                        ...
                        <div class="text-sm leading-tight text-gray-800 dark:text-gray-100">
                            <div class="font-semibold"><?php echo e(__('modules.order.setAsDefault')); ?></div>
                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e(__('modules.order.skipThisSelectionNextTime')); ?></div>
                        </div>
                    </label>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectionStage === 'order_type'): ?>
                    <!-- Order Types Selection -->
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orderTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <button wire:click="selectOrderType(<?php echo e($orderType->id); ?>, '<?php echo e($orderType->slug); ?>')"
                            ...
                            <?php echo e($selectedOrderTypeSlug === $orderType->slug
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedOrderTypeSlug === $orderType->slug): ?>
                            ...
                            <div class="mb-3 p-3 rounded-lg <?php echo e($selectedOrderTypeSlug === $orderType->slug ? 'bg-skin-base/10' : 'bg-gray-50 dark:bg-gray-900 group-hover:bg-skin-base/5'); ?> transition-colors duration-200">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderType->slug === 'dine_in'): ?>
                                ...
                                <?php elseif($orderType->slug === 'delivery'): ?>
                                ...
                                <?php elseif($orderType->slug === 'pickup'): ?>
                            ...
                            <span class="text-sm font-semibold text-gray-900 dark:text-white text-center"><?php echo e($orderType->translated_name); ?></span>
                        </button>
                        ...
                        <div class="col-span-full text-center py-12">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 font-medium"><?php echo app('translator')->get('modules.order.noOrderTypesAvailable'); ?></p>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php else: ?>
                        ...
                        <button type="button" wire:click="selectDeliveryPlatformAndProceed('default')"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.order.defaultDeliveryPlatform'); ?></p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo app('translator')->get('modules.order.standardDeliveryPricing'); ?></p>
                                </div>
                            </div>
                        </button>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $deliveryPlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" wire:click="selectDeliveryPlatformAndProceed(<?php echo e($platform->id); ?>)"
                            class="group text-left p-4 rounded-xl border-2 transition-all duration-200
                            border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800
                            hover:border-skin-base/50 hover:shadow-lg hover:scale-[1.02]">
                            <div class="flex items-center gap-3">
                                <div class="h-12 w-12 rounded-lg bg-gray-50 dark:bg-gray-900 flex items-center justify-center overflow-hidden flex-shrink-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($platform->logo)): ?>
                                        <img src="<?php echo e($platform->logo_url); ?>" alt="<?php echo e($platform->name); ?>" class="h-12 w-12 object-contain"/>
                                    <?php else: ?>
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e($platform->name); ?></p>
                                </div>
                            </div>
                        </button>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views/livewire/forms/order-type-selection.blade.php ENDPATH**/ ?>