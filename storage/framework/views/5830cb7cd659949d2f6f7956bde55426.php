<div class="max-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
    ...
    <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 py-4">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mx-4 sm:mx-7 space-y-4 sm:space-y-0">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.menu.sortManager'); ?></h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400"><?php echo app('translator')->get('modules.menu.sortManagerInfoMessage'); ?></p>
            </div>
            <div class="flex items-center w-full sm:w-auto gap-4">
                <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['wire:model.live.debounce.300ms' => 'search','class' => 'block w-full sm:w-64','type' => 'search','placeholder' => ''.e(__('placeholders.searchMenuOrCategory')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce.300ms' => 'search','class' => 'block w-full sm:w-64','type' => 'search','placeholder' => ''.e(__('placeholders.searchMenuOrCategory')).'']); ?>
...
<?php endif; ?>
    ...
    <div class="flex-1 grid grid-cols-1 md:grid-cols-12">
        ...
        <aside class="col-span-1 md:col-span-3 bg-white dark:bg-gray-800 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700">
            <div class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex justify-between items-center">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.menu.allMenus'); ?></h2>
                    <span wire:click="$set('selectedMenu', null)"
                        ...
                        <?php echo app('translator')->get('modules.restaurant.resetFilter'); ?>
                    </span>
                </div>
            </div>
            <ul wire:sortable="sortMenus" class="p-3 sm:p-4 space-y-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li wire:sortable.item="<?php echo e($menu->id); ?>"
                        wire:key="menu-<?php echo e($menu->id); ?>"
                        wire:click="$set('selectedMenu', <?php echo e($menu->id); ?>)"
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="flex flex-col items-center justify-center text-gray-500 dark:text-gray-400 py-8">
                        ...
                        <p class="text-sm font-medium"><?php echo app('translator')->get('messages.noRecordFound'); ?></p>
                    </div>
        ...
        <aside class="col-span-1 md:col-span-3 bg-white dark:bg-gray-800 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700">
            <div class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.menu.itemCategory'); ?></h2>
            </div>
            <div wire:sortable="sortCategories" class="p-3 sm:p-4 space-y-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div wire:sortable.item="<?php echo e($category->id); ?>"
                        wire:key="category-<?php echo e($category->id); ?>"
                        wire:click="$set('selectedCategory', <?php echo e($category->id); ?>)"
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <?php echo e($category->items_count); ?>
        ...
        <div class="col-span-1 md:col-span-6 bg-gray-50 dark:bg-gray-900">
            <div wire:sortable="sortItems"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div wire:sortable.item="<?php echo e($item->id); ?>"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <img src="<?php echo e($item->item_photo_url); ?>" alt="<?php echo e($item->item_name); ?>"
                                class="h-10 w-10 object-cover rounded-lg flex-shrink-0">
                            <span class="font-medium text-gray-900 dark:text-white"><?php echo e($item->item_name); ?></span>
                            <div class="flex items-center gap-2 ltr:ml-auto rtl:mr-auto">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full">
                                    <?php echo e($item->menu->menu_name); ?>
                ...
                <div class="col-span-2 flex flex-col items-center justify-center text-gray-500 dark:text-gray-400 py-12">
                    ...
                    <p class="text-lg font-medium"><?php echo app('translator')->get('messages.noRecordFound'); ?></p>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views/livewire/menu/sorting-component.blade.php ENDPATH**/ ?>