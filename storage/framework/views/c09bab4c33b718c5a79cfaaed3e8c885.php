...
<input x-data x-cloak x-init="
    ...
    const phpFormat = '<?php echo e($phpFormat); ?>';
    ...
    const pickerConfig = {
        field: inputElement,
        format: '<?php echo e($pikadayFormat); ?>',
        position: 'bottom right',
        toString: function(date, format) {
            return formatDateToString(date, '<?php echo e($phpFormat); ?>');
        },
        onSelect: function (selectedDate) {
            ...
            try {
                ...
                const formattedDate = formatDateToString(selectedDate, '<?php echo e($phpFormat); ?>');
    ...
    <?php if($minDate): ?>
    pickerConfig.minDate = <?php echo e($minDateJs); ?>;
    <?php endif; ?>
    <?php if($maxDate): ?>
    pickerConfig.maxDate = <?php echo e($maxDateJs); ?>;
    <?php endif; ?>
    ...
    function initializePicker() {
        ...
        try {
            ...
            if (!currentValue || currentValue.trim() === '') {
                ...
                currentValue = '<?php echo e($initialValue); ?>';
    ...
    " x-ref="input" type="text" <?php echo $attributes->merge(['class' =>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views/components/datepicker.blade.php ENDPATH**/ ?>