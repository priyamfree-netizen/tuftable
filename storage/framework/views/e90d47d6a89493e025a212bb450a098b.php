<div
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex-shrink-0">
            <span class="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white"><?php echo e(currency_format($monthlyEarnings, restaurant()->currency_id)); ?></span>
        ...
        function getMainChartOptions()
        {
            ...
            return {
                ...
                series: [
                    {
                        ...
                        data: [
                            <?php $__currentLoopData = $salesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                xaxis: {
                    categories: [
                        <?php $__currentLoopData = $salesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            "<?php echo e(\Carbon\Carbon::parse($label->date)->format(dateFormat())); ?>",
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ],
                    labels: {
                        style: {
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views/livewire/dashboard/weekly-sales-chart.blade.php ENDPATH**/ ?>