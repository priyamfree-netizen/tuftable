...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['style' => session('flash.bannerStyle', 'success'), 'message' => session('flash.banner'), 'link' => session('flash.link', null)]));
...
foreach (array_filter((['style' => session('flash.bannerStyle', 'success'), 'message' => session('flash.banner'), 'link' => session('flash.link', null)]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="<?php echo e(json_encode(['show' => true, 'style' => $style, 'message' => $message, 'link' => $link])); ?>"
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\components\banner.blade.php ENDPATH**/ ?>