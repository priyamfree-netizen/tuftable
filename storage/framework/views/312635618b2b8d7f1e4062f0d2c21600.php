...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-link','data' => ['href' => ''.e(route('pos.index')).'','class' => 'inline-flex items-center px-0.5 py-0.5 gap-1 text-xs ltr:mr-2 rtl:ml-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('pos.index')).'','class' => 'inline-flex items-center px-0.5 py-0.5 gap-1 text-xs ltr:mr-2 rtl:ml-2']); ?>
        ...
        <span class="hidden lg:block"><?php echo app('translator')->get('menu.pos'); ?></span>
...
<?php endif; ?>
    <div id="pos-shortcut-tooltip-toggle" role="tooltip"
        ...
        <?php echo app('translator')->get('menu.pos'); ?>
        <div class="tooltip-arrow" data-popper-arrow></div>
    </div>
    </div>
</div>
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\dashboard\pos-short-cut.blade.php ENDPATH**/ ?>