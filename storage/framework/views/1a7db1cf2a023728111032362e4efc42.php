<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fetchSetting->purchase_code): ?>

    <div class="flex items-center gap-2">
        <code class="blur-sm purchase-code text-sm bg-gray-100 px-1 py-1 rounded text-[11px]"  onclick="copyPurchaseCode(this)" data-code="<?php echo e($fetchSetting->purchase_code); ?>"><?php echo e($fetchSetting->purchase_code); ?> </code>

        <button type="button" class="text-gray-500 hover:text-gray-700 rounded-lg show-hide-purchase-code-<?php echo e(strtolower($module)); ?> group relative">
            ...
            <div class="pointer-events-none hidden group-hover:block absolute z-[9999] w-48 px-2 py-1
                ...
                <?php echo e(__('messages.showHidePurchaseCode')); ?>
        ...
        <button type="button" class="text-blue-600 hover:text-blue-700 rounded-lg verify-module group relative"
            ...
            <div class="pointer-events-none hidden group-hover:block absolute z-[9999] w-48 px-2 py-1
                      ...
                      before:content-[''] before:absolute before:right-0 before:top-1/2 before:-translate-y-1/2
                      before:border-4 before:border-transparent before:border-l-gray-900">
                <?php echo e(__('messages.changePurchaseCode')); ?>

            </div>
        </button>
    </div>
<?php else: ?>
    <button type="button" class="text-blue-600 hover:text-blue-800 underline inline-flex items-center verify-module" data-module="<?php echo e(strtolower($module)); ?>">
        ...
        <?php echo app('translator')->get('app.verifyEnvato'); ?>
    </button>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<script>
    document.body.addEventListener('click', function (event) {
        if (event.target.closest('.show-hide-purchase-code-<?php echo e(strtolower($module)); ?>')) {
            const button = event.target.closest('.show-hide-purchase-code-<?php echo e(strtolower($module)); ?>');
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\custom-modules\sections\purchase-code.blade.php ENDPATH**/ ?>