<div>
    ...
    <div class="p-4 bg-white dark:bg-gray-800">
        <div class="mb-4">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.refund.refundReport'); ?></h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                <?php echo app('translator')->get('modules.refund.refundReportMessage'); ?>
                <?php
        ...
        <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div class="p-4 bg-skin-base/10 rounded-xl shadow-sm dark:bg-skin-base/10 border border-skin-base/30 dark:border-skin-base/40">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-skin-base dark:text-skin-base"><?php echo app('translator')->get('modules.refund.totalRefunds'); ?></h3>
            ...
            <div class="p-4 bg-red-50 rounded-xl shadow-sm dark:bg-red-900/10 border border-red-100 dark:border-red-800">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-red-600 dark:text-red-400"><?php echo app('translator')->get('modules.refund.totalRefundAmount'); ?></h3>
                ...
                <p class="text-3xl break-words font-bold text-gray-800 dark:text-gray-100">
                    <?php echo e(currency_format($this->totalRefundAmount, restaurant()->currency_id)); ?>
            ...
            <div class="p-4 bg-blue-50 rounded-xl shadow-sm dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-blue-600 dark:text-blue-400"><?php echo app('translator')->get('modules.refund.totalOriginalAmount'); ?></h3>
                ...
                <p class="text-3xl break-words font-bold text-gray-800 dark:text-gray-100">
                    <?php echo e(currency_format($this->totalOriginalAmount, restaurant()->currency_id)); ?>
            ...
            <div class="p-4 bg-orange-50 rounded-xl shadow-sm dark:bg-orange-900/10 border border-orange-100 dark:border-orange-800">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-orange-600 dark:text-orange-400"><?php echo app('translator')->get('modules.refund.commissionAdjustment'); ?></h3>
                ...
                <p class="text-3xl break-words font-bold text-gray-800 dark:text-gray-100">
                    <?php echo e(currency_format($this->totalCommissionAdjustment, restaurant()->currency_id)); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'search','class' => 'block w-full pr-10','type' => 'text','placeholder' => ''.e(__('placeholders.searchRefunds')).'','wire:model.live.debounce.500ms' => 'searchTerm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['id' => 'refundTypeFilter','class' => 'block w-full sm:w-auto','wire:model.live' => 'refundTypeFilter']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'refundTypeFilter','class' => 'block w-full sm:w-auto','wire:model.live' => 'refundTypeFilter']); ?>
                    <option value=""><?php echo app('translator')->get('app.all'); ?> <?php echo app('translator')->get('modules.refund.refundTypes'); ?></option>
                    <option value="full"><?php echo app('translator')->get('modules.refund.fullRefund'); ?></option>
                    <option value="partial"><?php echo app('translator')->get('modules.refund.partialRefund'); ?></option>
                    <option value="waste"><?php echo app('translator')->get('modules.refund.wasteRefund'); ?></option>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaled2cde6083938c436304f332ba96bb7c)): ?>
<?php $attributes = $__attributesOriginaled2cde6083938c436304f332ba96bb7c; ?>
            ...
            <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-left rtl:text-right text-gray-600 uppercase dark:text-gray-300">
                        <button wire:click="sortByToggle('processed_at')" class="hover:text-gray-900 dark:hover:text-white transition-colors <?php echo e($sortBy === 'processed_at' ? 'font-bold text-gray-900 dark:text-white' : ''); ?>">
                    ...
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-left rtl:text-right text-gray-600 uppercase dark:text-gray-300">
                        <button wire:click="sortByToggle('refund_type')" class="hover:text-gray-900 dark:hover:text-white transition-colors <?php echo e($sortBy === 'refund_type' ? 'font-bold text-gray-900 dark:text-white' : ''); ?>">
                            <?php echo app('translator')->get('modules.refund.refundType'); ?>
                        </button>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-left rtl:text-right text-gray-600 uppercase dark:text-gray-300">
                        <?php echo app('translator')->get('modules.settings.refundReason'); ?>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-left rtl:text-right text-gray-600 uppercase dark:text-gray-300">
                        <button wire:click="sortByToggle('processed_by')" class="hover:text-gray-900 dark:hover:text-white transition-colors <?php echo e($sortBy === 'processed_by' ? 'font-bold text-gray-900 dark:text-white' : ''); ?>">
                            <?php echo app('translator')->get('modules.refund.processedBy'); ?>
                        </button>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-right rtl:text-left text-gray-600 uppercase dark:text-gray-300">
                        <?php echo app('translator')->get('modules.refund.originalPrice'); ?>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-right rtl:text-left text-gray-600 uppercase dark:text-gray-300">
                        <button wire:click="sortByToggle('amount')" class="hover:text-gray-900 dark:hover:text-white transition-colors ltr:ml-auto rtl:mr-auto <?php echo e($sortBy === 'amount' ? 'font-bold text-gray-900 dark:text-white' : ''); ?>">
                            <?php echo app('translator')->get('modules.refund.refundedAmount'); ?>
                        </button>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-right rtl:text-left text-gray-600 uppercase dark:text-gray-300">
                        <?php echo app('translator')->get('modules.refund.resalePrice'); ?>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-left rtl:text-right text-gray-600 uppercase dark:text-gray-300">
                        <?php echo app('translator')->get('modules.order.deliveryApp'); ?>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-right rtl:text-left text-gray-600 uppercase dark:text-gray-300">
                        <?php echo app('translator')->get('modules.refund.commissionAdjustment'); ?>
                    </th>
                    <th class="px-4 py-3 text-xs font-medium tracking-wider ltr:text-left rtl:text-right text-gray-600 uppercase dark:text-gray-300">
                        <?php echo app('translator')->get('modules.refund.inventoryChange'); ?>
                    </th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                            <?php echo e($refund->processed_at ? \Carbon\Carbon::parse($refund->processed_at)->setTimezone(timezone())->format('M d, Y') : '-'); ?>

                        </td>
                        <td class="px-4 py-3 text-sm font-medium text-gray-900 dark:text-white">
                            <?php echo e($refund->payment && $refund->payment->order ? ($refund->payment->order->show_formatted_order_number ?? $refund->payment->order->order_number) : '-'); ?>
                        ...
                        <td class="px-4 py-3 text-sm">
                            ...
                            ?>
                            <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($typeColors[$refund->refund_type] ?? 'bg-gray-100 text-gray-800'); ?>">
                                <?php echo e($typeLabels[$refund->refund_type] ?? $refund->refund_type); ?>

                            </span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($refund->refund_type === 'partial' && $refund->partial_refund_type): ?>
                                <?php
                                    $partialTypeLabels = [
                                ...
                                <span class="ml-1 text-xs text-gray-500 dark:text-gray-400">
                                    (<?php echo e($partialTypeLabels[$refund->partial_refund_type] ?? $refund->partial_refund_type); ?>)
                                </span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                            <?php echo e($refund->refundReason->reason ?? '-'); ?>

                        </td>
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                            <?php echo e($refund->processedBy->name ?? '-'); ?>

                        </td>
                        <td class="px-4 py-3 text-sm font-medium text-gray-900 dark:text-white text-right">
                            <?php echo e(currency_format($refund->payment->amount ?? 0, restaurant()->currency_id)); ?>

                        </td>
                        <td class="px-4 py-3 text-sm font-medium text-red-600 dark:text-red-400 text-right">
                            <?php echo e(currency_format($refund->amount, restaurant()->currency_id)); ?>

                        </td>
                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400 text-right">
                            <?php echo e(__('app.na')); ?>

                        </td>
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($refund->deliveryPlatform): ?>
                                <?php echo e($refund->deliveryPlatform->name); ?>

                            <?php elseif($refund->payment && $refund->payment->order && $refund->payment->order->deliveryPlatform): ?>
                                <?php echo e($refund->payment->order->deliveryPlatform->name); ?>
                        ...
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white text-right">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($refund->commission_adjustment && $refund->commission_adjustment > 0): ?>
                                <span class="text-orange-600 dark:text-orange-400">
                                    <?php echo e(currency_format($refund->commission_adjustment, restaurant()->currency_id)); ?>
                        ...
                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($refund->refund_type === 'waste'): ?>
                                <span class="text-red-600 dark:text-red-400"><?php echo app('translator')->get('modules.refund.writeOff'); ?></span>
                            <?php else: ?>
                                <?php echo e(__('app.na')); ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\reports\refund-report.blade.php ENDPATH**/ ?>