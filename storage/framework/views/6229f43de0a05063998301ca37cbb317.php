<div>
    ...
    <div id="tooltip-wifi" role="tooltip"
        ...
        <?php echo app('translator')->get('menu.wifi'); ?>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md p-6 mx-2 md:m-0 max-w-md w-full">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('menu.wifi'); ?></h3>
                    </div>
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            <?php echo app('translator')->get('modules.settings.wifiName'); ?>
                        </label>
                        <div class="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0"></path>
                            </svg>
                            <span class="text-gray-900 dark:text-white font-medium flex-1"><?php echo e($restaurant->wifi_name); ?></span>
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            <?php echo app('translator')->get('modules.settings.wifiPassword'); ?>
                        </label>
                        <div class="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                            </svg>
                            <span class="text-gray-900 dark:text-white font-medium font-mono flex-1"><?php echo e($restaurant->wifi_password); ?></span>
                            <button id="wifi-copy-button" type="button" onclick="copyWifiPassword('<?php echo e($restaurant->wifi_password); ?>')" 
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'closeWifiModal']); ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\forms\wifi-button.blade.php ENDPATH**/ ?>