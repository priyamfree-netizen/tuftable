    ...
    <div>
        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                <div class="mb-4">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white"><?php echo app('translator')->get('menu.deliveryExecutive'); ?></h1>
                </div>
...
<?php endif; ?>
                    ...
                    <div class="lg:inline-flex items-center gap-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Create Staff Member')): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','@click' => 'openAddExecutive()']); ?><?php echo app('translator')->get('modules.staff.addExecutive'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('deliveryExecutive.delivery-executive-table', ['search' => $search]);

$key = 'executive-table-'.e(microtime()).'';

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1833676252-0', 'executive-table-'.e(microtime()).'');
        ...
        >
            <div class="px-6 py-4 flex-1">
                <div class="text-lg font-medium text-gray-900 dark:text-gray-100">
                    <?php echo e(__("modules.staff.addExecutive")); ?>
...
[$__name, $__params] = $__split('forms.addExecutive');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1833676252-1', null);
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\delivery-executive\delivery-executive-list.blade.php ENDPATH**/ ?>