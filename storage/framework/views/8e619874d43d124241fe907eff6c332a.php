...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('modules.profile.browserSessions')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('modules.profile.browserSessionsDescription')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('modules.profile.browserSessionsContent')); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ms-3">
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                <?php echo e($session->agent->platform() ? $session->agent->platform() : __('modules.profile.unknown')); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : __('modules.profile.unknown')); ?>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($session->is_current_device): ?>
                                        <span class="text-green-500 font-semibold"><?php echo e(__('modules.profile.thisDevice')); ?></span>
                                    <?php else: ?>
                                        <?php echo e(__('modules.profile.lastActive')); ?> <?php echo e($session->last_active); ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('modules.profile.logOutOtherBrowserSessions')); ?>
...
<?php $component->withAttributes(['class' => 'ms-3','on' => 'loggedOut']); ?>
                <?php echo e(__('modules.profile.done')); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('modules.profile.confirmLogoutContent')); ?>


                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('app.password')).'','xRef' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('app.password')).'','x-ref' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\profile\logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>