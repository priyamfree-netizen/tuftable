...
<div style="background:#f8fafc;padding:80px 0 60px;">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div style="display:flex;gap:12px;flex-wrap:wrap;">
                    <a href="<?php echo e(route('restaurant_signup')); ?>" style="padding:14px 32px;background:#4f46e5;color:#fff;border-radius:999px;font-weight:700;font-size:15px;text-decoration:none;">Start Free Trial</a>
                    <a href="<?php echo e(route('landing.contact')); ?>" style="padding:14px 32px;background:#fff;color:#111827;border:2px solid #e5e7eb;border-radius:999px;font-weight:700;font-size:15px;text-decoration:none;">Contact Us</a>
                </div>
            </div>
            <div class="col-lg-6" style="margin-top:40px;">
                <img src="<?php echo e($frontDetails->image_url ?? asset('landing/dashboard.png')); ?>" style="width:100%;border-radius:16px;box-shadow:0 20px 60px rgba(0,0,0,0.12);" alt="TufTable Dashboard" />
            </div>
        </div>
    </div>
</div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$frontFeatures->isEmpty() ): ?>
    <!-- Features -->
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto space-y-8">
        ...
        <div class="mx-auto mb-8 lg:mb-14 text-center">
            <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
                <?php echo e($frontDetails->feature_with_image_heading ?? __('landing.featureSection1')); ?>

            </h2>
        </div>
        <!-- End Title -->
        <!-- Grid -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $frontFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($feature->type == 'image'): ?>
                    ...
                    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32 mb-10 flex flex-col">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index % 2 == 0): ?>
                            <div class="w-full lg:w-[500px] lg:h-[500px] overflow-hidden rounded-xl border border-gray-100 shadow">
                                <img class="w-full h-full object-cover object-center"
                                    src="<?php echo e($feature->image ? asset('user-uploads/front_feature/' . $feature->image) : asset('landing/order-management.png')); ?>"
                        ...
                        <?php else: ?>
                            ...
                            <div class="w-full lg:w-[500px] lg:h-[500px] overflow-hidden rounded-xl border border-gray-100 shadow order-1 md:order-2">
                                <img class="w-full h-full object-cover object-center"
                                    src="<?php echo e($feature->image ? asset('user-uploads/front_feature/' . $feature->image) : asset('landing/table-reservation.png')); ?>"
                                    alt="<?php echo e($feature->title); ?>">
                            </div>
                            <!-- End Col -->
    ...
    <div class="max-w-[85rem] mt-6 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="mx-auto  mb-8 lg:mb-14 text-center">
            <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
                <?php echo e($frontDetails->feature_with_icon_heading ?? __('landing.featureSection2')); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $frontFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div>
                        <div
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($feature->image)): ?>
                        ...
                        <div class="mt-5">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo e($feature->title); ?></h3>
                            <div class="prose prose-gray dark:prose-invert max-w-none"><?php echo $feature->description; ?></div>
                        </div>
                    </div>
                    <!-- End Icon Block -->
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$frontReviews->isEmpty()): ?>
    <!-- Testimonials -->
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="mx-auto  mb-8 lg:mb-14 text-center">
            <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
            <?php echo e($frontDetails->review_heading ?? __('landing.testimonialSection1')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $frontReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Card -->
                    <div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700">
                        ...
                        <div class="p-4 rounded-b-xl md:px-6">
                            ...
                            <p class="text-sm text-gray-500 dark:text-neutral-500">
                                <?php echo e($review->reviewer_designation); ?>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6" style="padding:12px;">
                    <div style="background:#fff;border-radius:20px;padding:36px 32px;height:100%;display:flex;flex-direction:column;">
                        ...
                        <a href="<?php echo e(route('landing.contact')); ?>" style="display:block;text-align:center;padding:14px;border:2px solid #111827;border-radius:999px;font-weight:700;font-size:15px;color:#111827;text-decoration:none;" onmouseover="this.style.background='#111827';this.style.color='#fff'" onmouseout="this.style.background='transparent';this.style.color='#111827'">Get Started</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" style="padding:12px;">
                    <div style="background:#4f46e5;border-radius:20px;padding:36px 32px;height:100%;display:flex;flex-direction:column;position:relative;box-shadow:0 24px 60px rgba(79,70,229,0.45);">
                        ...
                        <a href="<?php echo e(route('landing.contact')); ?>" style="display:block;text-align:center;padding:14px;background:#fff;border-radius:999px;font-weight:700;font-size:15px;color:#4f46e5;text-decoration:none;" onmouseover="this.style.background='#fef08a'" onmouseout="this.style.background='#fff'">Get Started</a>
                    </div>
                </div>
            ...
            <div style="margin-top:48px;text-align:center;">
                ...
                <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:10px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['KOT System','QR Menu','GST Billing','Table Management','Sales Reports','Customer Management','Menu Builder','Payment Tracking','Expense Tracking','Item Modifiers','Reservation System','Delivery Module']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span style="background:#1e293b;color:#94a3b8;font-size:12px;padding:5px 14px;border-radius:999px;"><?php echo e($feat); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$frontFaqs->isEmpty()): ?>
    <!-- FAQ -->
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="user-faqs">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">
                    <?php echo e($frontDetails->faq_heading ?? __('landing.faqTitle1')); ?>

            </h2>
            <div class="mt-1 text-gray-600 dark:text-neutral-400"><?php echo $frontDetails->faq_description ?? __('landing.faqSubTitle1'); ?></div>
        </div>
        <!-- End Title -->
            <div class="max-w-5xl mx-auto">
                <!-- Grid -->
                <div class="grid sm:grid-cols-2 gap-6 md:gap-12">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $frontFaqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frontFaq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
    ...
    <div class="max-w-7xl px-4 lg:px-8 py-12 lg:py-24 mx-auto">
        <div class="mb-6 sm:mb-10 max-w-2xl text-center mx-auto">
            <h2 class="font-medium text-black text-2xl sm:text-4xl dark:text-white">
                <?php echo e($frontDetails->contact_heading ?? __('landing.contactTitle')); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($frontContact->image)): ?>
                <img class="group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl w-full"
                    src="<?php echo e(asset('user-uploads/contact_image/' . $frontContact->image)); ?>"
                    alt="Contact Image">
            <?php else: ?>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="grow">
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                     <?php echo e($frontContact->contact_company ?? __('landing.contactCompany')); ?>

                                </p>
                                <address class="mt-1 text-black not-italic dark:text-white">
                                     <?php echo e($frontContact->address ?? __('landing.contactAddress')); ?>
                            ...
                            <div class="grow">
                                ...
                                <p>
                                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-skin-base hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white"
                                        href="mailto:<?php echo e($frontContact->email ?? __('landing.contactEmail')); ?>">
                                         <?php echo e($frontContact->email ?? __('landing.contactEmail')); ?>
...
<?php echo $__env->make('layouts.landing-page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/tuftable/resources/views/landing/dynamic-index.blade.php ENDPATH**/ ?>