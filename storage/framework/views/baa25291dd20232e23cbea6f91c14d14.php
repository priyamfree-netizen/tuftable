...
<?php $component->withAttributes([]); ?>
                    <div class="flex justify-between w-full">
                        <?php echo e(__('messages.fileUploaded')); ?>

                        <a href="<?php echo e($fileUrl); ?>" target="_blank" class="underline underline-offset-1"><?php echo app('translator')->get('app.view'); ?></a>
                    </div>
...
<?php endif; ?>
            ...
            <!-- Error Message -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['file_error'];
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'file','value' => ''.e(__('modules.settings.testStorageFile')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'file','value' => ''.e(__('modules.settings.testStorageFile')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div wire:loading wire:target="file" class="mt-2">
                    <div class="flex items-center space-x-2 text-sm text-blue-600 dark:text-blue-400">
                        ...
                        <span><?php echo app('translator')->get('app.uploading'); ?>...</span>
                    </div>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:loading.attr' => 'disabled','wire:loading.class' => 'opacity-50 cursor-not-allowed']); ?>
                <span wire:loading.disabled wire:target="file"><?php echo app('translator')->get('app.save'); ?></span>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$dispatch(\'hideTestStorageModal\')','wire:loading.attr' => 'disabled']); ?><?php echo app('translator')->get('app.cancel'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\forms\test-storage.blade.php ENDPATH**/ ?>