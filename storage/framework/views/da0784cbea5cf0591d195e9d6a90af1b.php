  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center justify-start">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex ltr:ml-2 rtl:mr-2 items-center app-logo gap-2 min-w-0">
          <img src="<?php echo e(restaurant()->logoUrl); ?>" class="h-7 w-7 sm:h-8 sm:w-8 ltr:mr-1 sm:ltr:mr-3 rtl:ml-1 sm:rtl:ml-3 shrink-0" alt="" />
          ...
          <span class="self-center text-lg sm:text-xl font-semibold whitespace-nowrap dark:text-white hidden lg:block ltr:mr-2 rtl:ml-2 truncate max-w-[45vw]"><?php echo e(Str::limit(restaurant()->name, 10)); ?></span>
        ...
        <div class="flex gap-2">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('Order', restaurant_modules()) && user_can('Show Order') && restaurant()->hide_new_orders == 0): ?>
            <?php
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1910748307-0', null);
...
?>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('Reservation', restaurant_modules()) && user_can('Show Reservation') && restaurant()->hide_new_reservations == 0 && in_array('Table Reservation', restaurant_modules())): ?>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1910748307-1', null);
...
?>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('Waiter Request', restaurant_modules()) && user_can('Manage Waiter Request') && restaurant()->hide_new_waiter_request == 0): ?>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1910748307-2', null);
...
[$__name, $__params] = $__split('dashboard.posShortCut');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1910748307-3', null);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1910748307-4', null);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1910748307-5', null);
...
?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(restaurant()->package->package_type == \App\Enums\PackageType::DEFAULT): ?>
            <?php $upgradeText = __('modules.settings.upgradeLicense'); ?>
            <a href="<?php echo e(route('pricing.plan')); ?>" wire:navigate class="hidden md:block inline-flex" data-tooltip-target="upgrade-tooltip-toggle" data-tooltip-placement="bottom">
                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['class' => 'inline-flex items-center gap-2 shadow-md text-skin-base dark:text-skin-base hover:origin-center group px-2 sm:px-3','ariaLabel' => ''.e($upgradeText).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'inline-flex items-center gap-2 shadow-md text-skin-base dark:text-skin-base hover:origin-center group px-2 sm:px-3','aria-label' => ''.e($upgradeText).'']); ?>
                    ...
                    <span class="hidden sm:inline"><?php echo e($upgradeText); ?></span>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <?php elseif(restaurant()->package->package_type == \App\Enums\PackageType::TRIAL): ?>
            ...
            ?>
            <a href="<?php echo e(route('pricing.plan')); ?>" wire:navigate class="hidden md:block inline-flex" data-tooltip-target="trial-tooltip-toggle" data-tooltip-placement="bottom">
                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['class' => 'inline-flex items-center gap-2 px-2 sm:px-3 py-1','ariaLabel' => ''.e($trialText).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'inline-flex items-center gap-2 px-2 sm:px-3 py-1','aria-label' => ''.e($trialText).'']); ?>
                    <svg class="w-5 h-5 text-current group-hover:scale-110 duration-500 sm:hidden" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                        <path d="M3 7a2 2 0 0 1 2-2h2.586l1.707-1.707A1 1 0 0 1 10 3h4a1 1 0 0 1 .707.293L16.414 5H19a2 2 0 0 1 2 2v2H3V7Zm0 4h18v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7Zm8 2v4a1 1 0 1 0 2 0v-4a1 1 0 1 0-2 0Z"/>
                    </svg>
                    <span class="hidden sm:inline text-[10px] sm:text-sm whitespace-nowrap leading-4"><?php echo e($trialText); ?></span>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af)): ?>
<?php $attributes = $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af; ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center w-8">
          ...
          <div
            ...
            <ul class="py-1" role="none">
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Manage Settings') && in_array('Settings', restaurant_modules())): ?>
              <li>
        ...
        <div class="flex items-center w-8">
          ...
          <div
            ...
            <ul class="py-1" role="none">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('Customer Display', restaurant_modules())): ?>
              <li>
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_enabled('Kiosk') && in_array('Kiosk', restaurant_modules())): ?>
                <li>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views/navigation-menu.blade.php ENDPATH**/ ?>