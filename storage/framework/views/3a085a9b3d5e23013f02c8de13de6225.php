...
<head>
    ...
    <meta name="msapplication-TileImage" content="<?php echo e(restaurantOrGlobalSetting()->upload_fav_icon_apple_touch_icon_url); ?>">

    <title><?php echo e(global_setting()->name); ?></title>

    <meta name="keyword" content="<?php echo e(global_setting()->meta_keyword ?? ''); ?>">
    ...
    <div class="font-sans text-gray-900 dark:text-gray-100 antialiased">
        ...
        <div
            ...
            <div class="flex flex-col justify-center items-center space-y-4">
                <a class="flex gap-3 items-center app-logo">
                    <img src="<?php echo e($appTheme->logoUrl); ?>" class="h-14 w-14" alt="Logo" style="background:transparent;" />
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appTheme->show_logo_text): ?>
                        <span style="font-size:2rem;font-weight:800;letter-spacing:-0.02em;line-height:1;">
                            <span style="color:#C8F135;">Tuf</span><span style="color:#0D0D0D;" class="dark:text-white"> Table</span>
                        </span>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1097975996-0', null);
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(global_setting()->is_pwa_install_alert_show == 1): ?>
    <script>
        (function () {
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\layouts\auth.blade.php ENDPATH**/ ?>