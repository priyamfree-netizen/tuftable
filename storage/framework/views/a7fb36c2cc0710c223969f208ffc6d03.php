<div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-xl p-2">
    <div class="mb-2">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.delivery.selectDeliveryLocation'); ?></h2>
    </div>


    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inRange && $isDeliveryTimeAvailable): ?>
...
<?php $component->withAttributes(['class' => 'mt-4']); ?>
            <div class="flex items-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFreeDelivery): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($freeDeliveryOverAmount) && $orderGrandTotal >= $freeDeliveryOverAmount): ?>
                        (<?php echo app('translator')->get('modules.delivery.orderQualifiesForFreeDelivery'); ?>)
                ...
                <?php else: ?>
                    ...
                    <?php echo app('translator')->get('modules.delivery.deliveryFee'); ?>: <span class="font-semibold ml-1"><?php echo e(currency_format($deliveryFee, $currencyId)); ?></span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($distance): ?>
                        <span class="ml-2 text-sm text-gray-600 dark:text-gray-300">
                            (<?php echo e(number_format($branch->deliverySetting->unit === 'miles' ? $distance / 1.60934 : $distance, 2)); ?> <?php echo e($branch->deliverySetting->unit === 'miles' ? 'miles' : 'km'); ?>)
                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php $component->withAttributes(['class' => 'mt-4']); ?>
            <div class="flex items-center">
                ...
                <?php echo e($deliveryMessage ?? __('modules.delivery.locationOutOfRange')); ?>
...
<?php endif; ?>
    ...
    <div class="flex justify-end mb-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customerAllAddresses?->isNotEmpty()): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'toggleManualLocation','class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses([
                    'transition-colors duration-200',
                    'bg-blue-600' => !$showManualLocation,
                    'text-gray-700' => $showManualLocation,
                    'opacity-50' => !$isDeliveryTimeAvailable
                ])),'disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$isDeliveryTimeAvailable)]); ?>
                <svg class="w-5 h-5 mr-1 inline-flex" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showManualLocation): ?>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                    <?php else: ?>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </svg>
                <?php echo e($showManualLocation ? __('modules.delivery.useSavedAddress') : __('modules.delivery.useDifferentLocation')); ?>
...
<?php endif; ?>
    ...
    <div class="space-y-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customerAllAddresses?->isNotEmpty() && !$showManualLocation): ?>
            <div class="grid gap-6 md:grid-cols-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $customerAllAddresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative h-[120px]">
                        <div
                            wire:click="selectAddressFromSaved(<?php echo e($address->id); ?>)"
                            class="h-full p-4 bg-white dark:bg-gray-700 rounded-xl border-2 cursor-pointer
                                ...
                                <?php echo e($selectedAddressId == $address->id ? 'border-blue-500 dark:border-blue-400 ring-4 ring-blue-500/20' : 'border-gray-200 dark:border-gray-600'); ?>"
                        >
                            <div class="flex h-full gap-3">
                                <div class="flex-shrink-0">
                                    <div class="w-6 h-6 rounded-full border-2 flex items-center justify-center
                                        <?php echo e($selectedAddressId == $address->id ? 'border-blue-500' : 'border-gray-300 dark:border-gray-500'); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedAddressId == $address->id): ?>
                                            <div class="w-4 h-4 rounded-full bg-blue-500"></div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                <div class="flex-1 flex flex-col space-y-3 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white truncate"><?php echo e($address->label); ?></p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.textarea','data' => ['id' => 'delivery-address','wire:model.defer' => 'selectedAddress','rows' => '3','class' => 'w-full resize-none','placeholder' => ''.e(__('modules.delivery.fullAddressPlaceholder')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'delivery-address','wire:model.defer' => 'selectedAddress','rows' => '3','class' => 'w-full resize-none','placeholder' => ''.e(__('modules.delivery.fullAddressPlaceholder')).'']); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['for' => 'selectedAddress']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'selectedAddress']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => '$set(\'showManualLocation\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$set(\'showManualLocation\', false)']); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'selectDeliveryAddress','wire:loading.attr' => 'disabled','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$inRange || !$isDeliveryTimeAvailable),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses([
                            'px-6',
                            'opacity-50' => !$inRange || !$isDeliveryTimeAvailable
                        ]))]); ?>
                        <?php echo app('translator')->get('modules.delivery.confirmLocation'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'confirmSelectedAddress','wire:loading.attr' => 'disabled','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$inRange || !$isDeliveryTimeAvailable),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses(['bg-green-600 hover:bg-green-700',
                        'opacity-50' => !$inRange || !$isDeliveryTimeAvailable
                ]))]); ?>
                <?php echo app('translator')->get('modules.delivery.confirmLocation'); ?>
             <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <?php
        $__scriptKey = '3460585124-0';
        ob_start();
    ?>
    <script>
        const MAP_API_KEY = atob('<?php echo e(base64_encode($mapApiKey)); ?>');

        const STRINGS = {
            deliveryLocation: "<?php echo app('translator')->get('modules.delivery.deliveryLocation'); ?>",
            ...
            showRange: "<?php echo app('translator')->get('modules.delivery.showDeliveryRange'); ?>",
            hideRange: "<?php echo app('translator')->get('modules.delivery.hideDeliveryRange'); ?>",
            useCurrentLocation: "<?php echo app('translator')->get('modules.delivery.useCurrentLocation'); ?>",
            locationPermissionDenied: "<?php echo app('translator')->get('modules.delivery.locationPermissionDenied'); ?>",
        };
        ...
        function setupMap(params = {}) {
            ...
            const {
                branchLat = <?php echo \Illuminate\Support\Js::from($branchLat)->toHtml() ?>,
                branchLng = <?php echo \Illuminate\Support\Js::from($branchLng)->toHtml() ?>,
                maxKm = <?php echo \Illuminate\Support\Js::from($maxKm)->toHtml() ?>,
                defaultLat = <?php echo \Illuminate\Support\Js::from($customerLat)->toHtml() ?>,
                defaultLng = <?php echo \Illuminate\Support\Js::from($customerLng)->toHtml() ?>
            } = params?.[0] || {};
            ...
            const markerSvg = `<svg viewBox="0 0 512 512" style="position:absolute;left:0;bottom:0">
                ...
                <image href="<?php echo e($restaurantLogo); ?>" x="136" y="72" width="240" height="240" clip-path="circle(120px at center)"/>
            </svg>`;
        ...
        function addAutocomplete() {
            ...
            placeAutocomplete.addEventListener('gmp-select', async ({ placePrediction }) => {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('selectedAddress', formattedAddress);
        ...
        function updateLocation(latLng) {
            ...
            Livewire.dispatch('locationSelected', {
                lat,
                lng,
                address: window.Livewire.find('<?php echo e($_instance->getId()); ?>').get('selectedAddress')
            });
        }
        ...
        function reverseGeocode(latLng) {
            ...
            geocoder.geocode({ location: latLng }, (results, status) => {
                if (status === 'OK' && results[0]) {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('selectedAddress', results[0].formatted_address);
                }
            });
        }
    </script>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\customer\location-selector.blade.php ENDPATH**/ ?>