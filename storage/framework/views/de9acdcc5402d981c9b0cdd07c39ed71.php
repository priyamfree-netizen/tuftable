...
<a href="<?php echo e(route('orders.index')); ?>" wire:navigate wire:key="today-orders-link"
    ...
    <span <?php if(!pusherSettings()->is_enabled_pusher_broadcast): ?> wire:poll.15s.keep-alive="refreshOrders" wire:key="today-orders-count" <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views/livewire/dashboard/today-orders.blade.php ENDPATH**/ ?>