<div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showFilters): ?>
        <?php echo $__env->make('expenses.filter', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                    <?php echo app('translator')->get('modules.expenses.expenseTitle'); ?>
                                </th>
                                <th
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                ...
                                <th
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                    <?php echo app('translator')->get('modules.expenses.amount'); ?>
                                </th>
                                <th
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                    <?php echo app('translator')->get('modules.expenses.expenseDate'); ?>
                                </th>
                                <th
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                    <?php echo app('translator')->get('modules.expenses.paymentStatus'); ?>
                                </th>
                                <th
                                    class="py-2.5 px-4 text-xs font-medium ltr:text-left rtl:text-right text-gray-500 uppercase dark:text-gray-400">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <td class="py-2.5 px-2 text-gray-900 dark:text-white">
                                            <button wire:click="showExpenseDetails(<?php echo e($expense->id); ?>)"
                                                wire:key="expense-detail-button-<?php echo e($expense->id); ?>"
                                        ...
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e(Str::title($expense->expense_title)); ?></td>
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e(optional($expense->category)->name ?? '--'); ?></td>
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e(currency_format($expense->amount, restaurant()->currency_id)); ?></td>
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e($expense->expense_date->format(dateFormat())); ?>
                                        ...
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                ...
                                                <?php echo app('translator')->get('modules.expenses.status.' . $expense->payment_status); ?>
                                            </span>
                                        </td>
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e($expense->payment_date ? $expense->payment_date->format(dateFormat()) : '--'); ?>

                                        </td>
                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php echo e($expense->payment_due_date ? $expense->payment_due_date->format(dateFormat()) : '--'); ?>

                                        </td>

                                        <td class="py-2.5 px-4 text-gray-900 dark:text-white">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$expense->payment_method): ?>
                                                <span
                                            ...
                                            <?php else: ?>
                                                <?php echo app('translator')->get('modules.expenses.methods.' . $expense->payment_method); ?>

                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expense->payment_method == 'cash'): ?>
                                                    <span
                                                        class="ml-2 inline-flex items-center px-2.5 py-1.5 rounded text-xs font-medium bg-gray-100 text-gray-800">
                                                ...
                                                <?php elseif($expense->payment_method == 'bank_transfer'): ?>
                                                    <span
                                                ...
                                                <?php elseif($expense->payment_method == 'credit_card'): ?>
                                                    <span
                                                ...
                                                <?php elseif($expense->payment_method == 'debit_card'): ?>
                                                    <span
                                                ...
                                                <?php elseif($expense->payment_method == 'check'): ?>
                                                    <span
                                                ...
                                                <?php elseif($expense->payment_method == 'digital_wallet'): ?>
                                                    <span
                                        ...
                                        <td class="py-2.5 px-4 space-x-2 text-right">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Update Expense')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button-table','data' => ['wire:click' => 'showEditExpense('.e($expense->id).')','wire:key' => 'edit-expense-button-'.e($expense->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'showEditExpense('.e($expense->id).')','wire:key' => 'edit-expense-button-'.e($expense->id).'']); ?>
...
<?php endif; ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Delete Expense')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button-table','data' => ['wire:click' => 'showDeleteMenuexpense('.e($expense->id).')','wire:key' => 'delete-expense-button-'.e($expense->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'showDeleteMenuexpense('.e($expense->id).')','wire:key' => 'delete-expense-button-'.e($expense->id).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.right-modal','data' => ['wire:model.live' => 'showExpenseDetailsModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showExpenseDetailsModal']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <?php echo e(__('modules.expenses.expenseDetails')); ?>

         <?php $__env->endSlot(); ?>

         <?php $__env->slot('content', null, []); ?> 
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewExpenseDetails): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('payments.expense-details', ['expenses' => $viewExpenseDetails]);

$key = microtime();

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-208688180-0', microtime());
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2b7129b9a6e7f6a1be2b5d072517af13 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.right-modal','data' => ['wire:model.live' => 'showEditExpenseModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('right-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showEditExpenseModal']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <?php echo e(__('modules.expenses.editExpense')); ?>

         <?php $__env->endSlot(); ?>

         <?php $__env->slot('content', null, []); ?> 
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedExpenses): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('forms.EditExpense', ['expenses' => $selectedExpenses]);

$key = str()->random(50);

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-208688180-1', str()->random(50));
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['wire:model.live' => 'confirmDeleteExpense']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'confirmDeleteExpense']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <?php echo app('translator')->get('modules.expenses.deleteExpense'); ?>?
         <?php $__env->endSlot(); ?>

         <?php $__env->slot('content', null, []); ?> 
            <?php echo app('translator')->get('modules.expenses.deleteExpensesMessage'); ?>
         <?php $__env->endSlot(); ?>

         <?php $__env->slot('footer', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => '$toggle(\'confirmDeleteExpense\')','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$toggle(\'confirmDeleteExpense\')','wire:loading.attr' => 'disabled']); ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deleteExpense): ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\payments\expenses.blade.php ENDPATH**/ ?>