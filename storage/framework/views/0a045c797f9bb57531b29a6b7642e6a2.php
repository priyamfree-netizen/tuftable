<?php $__env->startSection('content'); ?>
    ...
    <div class="overflow-hidden" id="simple-pricing">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="mx-auto mb-8 lg:mb-14 text-center">
                <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
                    <?php echo e($frontDetails->price_heading ?? __('landing.pricingTitle1')); ?>

                </h2>
                <div class="my-5 font-light text-gray-500 sm:text-base dark:text-gray-400">
                    <?php echo $frontDetails->price_description ?? __('landing.pricingSubTitle1'); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\landing\dynamic-index.blade.php ENDPATH**/ ?>