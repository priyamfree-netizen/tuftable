                        ...
                        <div class="flex-1 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 flex flex-col justify-center">
                            <div class="flex flex-col items-center justify-center h-full text-center">
                                <div class="w-16 h-16 flex items-center justify-center mx-auto mb-3">
                                    <img src="<?php echo e(asset('img/icon.png')); ?>" alt="TableTrack Desktop App" class="w-14 h-14 object-contain">
                                </div>
            ...
            <?php echo app('translator')->get('superadmin.saving'); ?>
                    ...
                    <div class="py-10 mb-6 p-6 border rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-purple-200 dark:border-purple-800">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-3">
                                <h5 class="text-lg font-semibold text-purple-900 dark:text-purple-100"><?php echo app('translator')->get('superadmin.whiteLabelDesktopApp'); ?></h5>
                                <p class="text-sm text-purple-700 dark:text-purple-300"><?php echo app('translator')->get('superadmin.whiteLabelDesktopAppDescription'); ?></p>
                            </div>
                        </div>

                        <div class="mb-4">
                            <h6 class="font-medium text-purple-800 dark:text-purple-200 mb-3"><?php echo app('translator')->get('superadmin.whiteLabelFeatures'); ?></h6>
                            <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-purple-700 dark:text-purple-300">
                                <li class="flex items-start">
                                    ...
                                    <?php echo app('translator')->get('superadmin.whiteLabelFeature1'); ?>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 text-purple-600 dark:text-purple-400 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <?php echo app('translator')->get('superadmin.whiteLabelFeature2'); ?>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 text-purple-600 dark:text-purple-400 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <?php echo app('translator')->get('superadmin.whiteLabelFeature3'); ?>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 text-purple-600 dark:text-purple-400 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <?php echo app('translator')->get('superadmin.whiteLabelFeature4'); ?>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="flex justify-center">
                            <a href="https://envato.froid.works/my-account?tab=desktop-app"
                                ...
                                <?php echo app('translator')->get('superadmin.orderWhiteLabelApp'); ?>
                            </a>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\settings\desktop-application-settings.blade.php ENDPATH**/ ?>