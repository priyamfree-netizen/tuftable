<div class="mx-2 mb-4 space-y-6 md:mx-0" <?php if(pusherSettings()->is_enabled_pusher_broadcast): ?> wire:poll.15s <?php endif; ?>>
...
<?php endif; ?>
    <div class="flex items-center justify-between">
        <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.settings.orderDetails'); ?></h2>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->shouldShowWaiterButtonMobile && $order->order_type === 'dine_in'): ?>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4092469808-0', null);
...
?>
    ...
    <div class="overflow-hidden rounded-lg bg-gray-50 dark:bg-gray-800">
        ...
        <div class="px-4 py-3 border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->order_status->value === 'cancelled'): ?>
                <div class="flex items-center gap-2 text-red-600 dark:text-red-400">
                    ...
                    <div>
                        ...
                        <p class="text-xs">
                            <?php echo app('translator')->get('modules.order.orderCancelledMessage'); ?>
                        </p>
                    </div>
                </div>
            <?php else: ?>
                ...
                <div>
                    ...
                    <div class="left-0 hidden w-full h-0.5 bg-gray-200 rounded sm:block top-5 mt-5 dark:bg-gray-600">
                        <div class="h-0.5 progress-bar-fill rounded bg-skin-base/80 dark:bg-skin-base/90"
                            style="width: <?php echo e(min(100, ($currentStepIndex / (count($steps) - 1)) * 100)); ?>%"></div>
                    </div>

                    <!-- Status Steps -->
                    <div class="flex flex-col justify-between text-gray-500 sm:flex-row sm:items-center sm:-mt-5 dark:text-gray-400">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                ]); ?>" data-status-step="<?php echo e($status); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index <= $currentStepIndex): ?>
                                        <svg class="w-4 h-4 <?php echo e($index < $currentStepIndex ? 'animate-checkmark' : ''); ?>" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($status):
                                            case ('placed'): ?>
                                                <svg <?php echo $svgBase; ?>>
                                                    <path <?php echo $pathBase; ?> d="M9 6a3 3 0 1 1 6 0v0a3 3 0 1 1-6 0M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                                                </svg>
                                            <?php break; ?>
                                            <?php case ('confirmed'): ?>
                                            ...
                                            <?php case ('ready_for_pickup'): ?>
                                                <svg <?php echo $svgBase; ?>>
                                                    <path <?php echo $pathBase; ?> d="M9 10a3 3 0 1 1 6 0v0a3 3 0 1 1-6 0m12 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                                                </svg>
                                            <?php break; ?>
                                            <?php case ('delivered'): ?>
                                                <svg <?php echo $svgBase; ?>>
                                                    <path <?php echo $pathBase; ?> d="M20 12a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-8-3v3l2 2"/>
                                                </svg>
                                            <?php break; ?>
                                            <?php case ('served'): ?>
                                                <svg <?php echo $svgBase; ?>>
                                                    <path <?php echo $pathBase; ?> d="M7 17.5h10M7 11v3m10-3v3m-5-3v3m-7.5-8h15c.8 0 1.5.7 1.5 1.5v10c0 .8-.7 1.5-1.5 1.5h-15c-.8 0-1.5-.7-1.5-1.5v-10c0-.8.7-1.5 1.5-1.5Z"/>
                                                </svg>
                                            <?php break; ?>
                                            <?php case ('food_ready'): ?>
        ...
        <div class="flex flex-col justify-between gap-3 mb-3 md:flex-row">
                ...
                <div class="flex flex-wrap gap-3 text-xs text-gray-600 dark:text-gray-400">
                    <div class="flex items-center gap-1.5">
                        ...
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($svgPath); ?>"/>
                        </svg>
                        <?php echo e(Str::of($order->order_type)->replace('_', ' ')->title()); ?>
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <?php echo e($order->pickup_date ? $order->pickup_date->timezone(timezone())->format($dateFormat . ' ' . $timeFormat) : ($order->date_time->timezone(timezone())->format($dateFormat . ' ' . $timeFormat))); ?>
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <?php echo e($order->items->count()); ?> <?php echo app('translator')->get('modules.menu.item'); ?>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->table_id): ?>
                        <div class="flex items-center gap-1.5">
                            ...
                            <?php echo app('translator')->get('modules.settings.tableNumber'); ?>
                            <span class="px-1.5 py-0.5 bg-skin-base text-gray-100 rounded-full text-xs font-medium">
                                <?php echo e($order->table->table_code ?? '--'); ?>
            ...
            <div class="flex items-center gap-1 md:flex-col md:items-end">
                <div class="text-lg font-bold text-gray-900 md:text-xl dark:text-white">
                    <?php echo e(currency_format($this->correctedTotal, $restaurant->currency_id)); ?>

                </div>
                <div class="text-xs text-gray-500 dark:text-gray-400 sm:ms-2">
                    <?php echo app('translator')->get('modules.order.includeTax'); ?>
                </div>
            </div>
        </div>

        <!-- Delivery Address -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->order_type === 'delivery' && $order->delivery_address): ?>
        ...
        <div class="p-2 mt-3 rounded-lg bg-skin-base/15">
            <div class="flex items-center gap-2 text-skin-base">
                ...
                <span class="text-xs font-medium text-skin-base">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($timeValue): ?>
                        <?php echo app('translator')->get($timeLabel); ?>: <?php echo e($timeValue); ?> <?php echo app('translator')->get('modules.menu.minutes'); ?>
                        <span>(<?php echo app('translator')->get('app.approx'); ?>)</span>
                    <?php else: ?>
                        <?php echo app('translator')->get('modules.delivery.estimatedTimeUnavailable'); ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </span>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant && !$restaurant->hide_menu_item_image_on_customer_site): ?>
                                <div class="flex items-center justify-center flex-shrink-0">
                                    <img class="object-cover w-12 h-12 rounded-lg shadow-sm ring-1 ring-gray-200 dark:ring-gray-700"
                                        src="<?php echo e($item->menuItem->item_photo_url); ?>"
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-3">
                                    <div class="space-y-1">
                                        <div class="flex flex-wrap items-center gap-1.5">
                                            <div class="inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                                                <img src="<?php echo e(asset('img/' . $item->menuItem->type . '.svg')); ?>" class="h-3.5 mr-1.5"
                                                    title="<?php echo app('translator')->get('modules.menu.' . $item->menuItem->type); ?>" alt="" />
                                        ...
                                        <div class="flex flex-wrap items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($taxMode === 'item' && $restaurant?->tax_inclusive && $item->tax_amount > 0): ?>
                                                <span class="font-medium">
                                                    <?php echo e(currency_format(($item->price + $modifierTotal) - ($item->tax_amount / $item->quantity), $restaurant->currency_id)); ?>
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <span class="font-medium">
                                                <?php echo e(currency_format($item->price + $modifierTotal, $restaurant->currency_id)); ?>
                                    ...
                                    <div class="space-y-1 text-xs">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->kot->isNotEmpty()): ?>
                                            <?php
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status): ?>
                                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium
                                                    <?php if($status === 'pending'): ?> bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-300
                                                    <?php elseif($status === 'cooking'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300
                                                    <?php elseif($status === 'ready'): ?> bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-300
                                                    <?php else: ?> bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-300
                                                    <?php endif; ?>">
                                    ...
                                    <div class="flex flex-wrap gap-1.5 mt-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $item->modifierOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-skin-base/10 text-skin-base">
                                                <?php echo e($modifier->name ?? $modifier->pivot->modifier_option_name); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->note): ?>
                                    <div class="mt-1 text-xs text-gray-800 dark:text-gray-200 line-clamp-2">
                                        <span class="font-medium"><?php echo app('translator')->get('modules.order.note'); ?>:</span> <?php echo e($item->note); ?>
            ...
            <div class="p-3 rounded-b-lg bg-gray-50 dark:bg-gray-700/50">
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <span class="text-gray-600 dark:text-gray-400"><?php echo app('translator')->get('modules.order.subTotal'); ?></span>
                            <?php
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayStampDiscountAmount > 0 || $hasFreeStampItems): ?>
                                <span class="px-1.5 py-0.5 text-xs rounded bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayStampDiscountAmount > 0): ?>
                                        (-<?php echo e(currency_format($displayStampDiscountAmount, $restaurant->currency_id)); ?>)
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayLoyaltyPointsRedeemed > 0 && $displayLoyaltyDiscountAmount > 0): ?>
                            <div class="flex justify-between text-sm text-green-600 dark:text-green-400 font-medium">
                                <div>
                                    <?php echo app('translator')->get('app.loyaltyDiscount'); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayLoyaltyPointsRedeemed > 0): ?>
                                        <span class="text-gray-600 dark:text-gray-400 font-normal">
                                            (<?php echo e(number_format($displayLoyaltyPointsRedeemed, 0)); ?> <?php echo app('translator')->get('app.points'); ?>)
                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <div>
                                    -<?php echo e(currency_format($displayLoyaltyDiscountAmount, $restaurant->currency_id)); ?>
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($order->discount_amount) && $checkLoyaltyPointsRedeemed == 0): ?>
                        <div wire:key="discountAmount"
                            class="flex justify-between text-xs text-green-500 dark:text-green-400">
                            <div>
                                <?php echo app('translator')->get('modules.order.discount'); ?> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->discount_type == 'percent'): ?>
                                    (<?php echo e(rtrim(rtrim(number_format($order->discount_value, 2), '0'), '.')); ?>%)
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div>
                                -<?php echo e(currency_format($order->discount_amount, $restaurant->currency_id)); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $applicableCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
                            ...
                            <div class="text-gray-900 dark:text-white">
                                ...
                                ?>
                                <?php echo e(currency_format($item->charge->getAmount($chargeBase), $restaurant->currency_id)); ?>
                        ...
                        <div class="mt-2">
                            <div class="space-y-1">
                                ...
                                <div class="flex justify-between text-xs text-gray-400 dark:text-gray-500">
                                    <span><?php echo e($taxName); ?> (<?php echo e($taxInfo['percent']); ?>%)</span>
                                    <span><?php echo e(currency_format($taxInfo['amount'], $restaurant->currency_id)); ?></span>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <div>
                                    <span class="text-gray-900 dark:text-white"><?php echo e(currency_format($totalTax, $restaurant->currency_id)); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->order_type === 'delivery' && !is_null($order->delivery_fee)): ?>
                        <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <div>
                                ...
                                <?php else: ?>
                                    <span class="font-medium text-green-500 dark:text-green-400"><?php echo app('translator')->get('modules.delivery.freeDelivery'); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLoyaltyEnabled ?? false): ?>
                        <?php
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-sm font-medium text-green-900 dark:text-green-200">
                                                <?php echo e(__('loyalty::app.loyaltyDiscountApplied')); ?>

                                            </p>
                                            <p class="text-xs text-green-700 dark:text-green-300 mt-1">
                                                <?php echo e(number_format($displayLoyaltyPointsRedeemed, 0)); ?> <?php echo app('translator')->get('loyalty::app.points'); ?> = <?php echo e(currency_format($displayLoyaltyDiscountAmount, $restaurant->currency_id)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['type' => 'button','wire:click' => 'removeLoyaltyRedemption','size' => 'sm','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => 'removeLoyaltyRedemption','size' => 'sm','wire:loading.attr' => 'disabled']); ?>
                                                <span wire:loading.remove wire:target="removeLoyaltyRedemption"><?php echo e(__('loyalty::app.remove')); ?></span>
...
<?php endif; ?>
                    ...
                    <?php
                        ...
                        $hasFreeStampItems = $order->items()->where('is_free_item_from_stamp', true)->exists();
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($isStampsEnabledForCustomerSite ?? false) && ($displayStampDiscountAmount > 0 || $hasFreeStampItems)): ?>
                        <div class="border-t border-gray-200 dark:border-gray-700 mt-3 pt-3">
                            <div class="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-green-900 dark:text-green-200">
                                            <?php echo e(__('loyalty::app.stampRedemptionApplied')); ?>

                                        </p>
                                        <p class="text-xs text-green-700 dark:text-green-300 mt-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasFreeStampItems && $displayStampDiscountAmount > 0): ?>
                                                <?php echo app('translator')->get('app.freeItem'); ?> + <?php echo e(currency_format($displayStampDiscountAmount, $restaurant->currency_id)); ?> <?php echo app('translator')->get('app.discount'); ?>
                                            <?php elseif($hasFreeStampItems): ?>
                                                <?php echo app('translator')->get('app.freeItem'); ?>
                                            <?php else: ?>
                                                <?php echo e(currency_format($displayStampDiscountAmount, $restaurant->currency_id)); ?> <?php echo app('translator')->get('app.discount'); ?>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </p>
                                    </div>
                                    <?php
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isPaid): ?>
                                        <?php if (isset($component)) { $__componentOriginal656e8c5ea4d9a4fa173298297bfe3f11 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal656e8c5ea4d9a4fa173298297bfe3f11 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['type' => 'button','wire:click' => 'removeStampRedemption','size' => 'sm','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('danger-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','wire:click' => 'removeStampRedemption','size' => 'sm','wire:loading.attr' => 'disabled']); ?>
                                            <span wire:loading.remove wire:target="removeStampRedemption"><?php echo e(__('loyalty::app.remove')); ?></span>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!(in_array($order->status, ['canceled', 'cancelled'], true)
                            || (($order->order_status->value ?? null) === 'cancelled'))): ?>
                        <!-- Loyalty Information Display (after order placed) -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($isPointsEnabledForCustomerSite ?? false) && ($customer ?? null)): ?>
                            <!-- Loyalty Points Summary -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($availableLoyaltyPoints ?? 0) > 0 || isset($currentTier)): ?>
                                    <div class="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                        <div class="flex items-center justify-between mb-3">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <h3 class="text-sm font-semibold text-blue-900 dark:text-blue-200"><?php echo e(__('loyalty::app.loyaltyAccount')); ?></h3>
                                            </div>
                                            <div class="text-right">
                                                <div class="text-xs text-blue-700 dark:text-blue-300"><?php echo e(__('loyalty::app.pointsBalance')); ?></div>
                                                <div class="text-xl font-bold text-blue-900 dark:text-blue-100"><?php echo e(number_format($availableLoyaltyPoints ?? 0)); ?></div>
                                            </div>
                                        </div>

                                        <!-- Tier Display -->
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($currentTier) && $currentTier): ?>
                                            <?php echo $__env->make('loyalty::components.tier-display', [
                                        ...
                                        <?php elseif(($availableLoyaltyPoints ?? 0) > 0): ?>
                                            <div class="text-xs text-blue-700 dark:text-blue-300 mt-2">
                                                <?php echo e(__('loyalty::app.noTierAssigned')); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($isPointsEnabledForCustomerSite ?? false) && ($customer ?? null)): ?>
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer && ($availableLoyaltyPoints ?? 0) > 0 && $order->status !== 'paid' && !$hasRedeemedPoints): ?>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <span class="text-xs font-medium text-gray-900 dark:text-white">
                                                    <?php echo app('translator')->get('loyalty::app.redeemLoyaltyPoints'); ?>
                                                </span>
                                            </div>
                                        </div>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'openLoyaltyRedemptionModal','class' => 'flex items-center text-xs','wire:loading.attr' => 'disabled']); ?>
                                                <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                </svg>
                                                <span><?php echo app('translator')->get('loyalty::app.redeem'); ?></span>
                                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($isStampsEnabledForCustomerSite ?? false) && ($customer ?? null)): ?>
                            <?php
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer && $hasRedeemableStamps && $order->status !== 'paid' && !$hasRedeemedStamps): ?>
                                <div class="border-t border-gray-200 dark:border-gray-700" wire:key="stamp-redemption-section">
                                    <div class="flex items-center justify-between gap-3 mt-2">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <span class="text-xs font-medium text-gray-900 dark:text-white">
                                                    <?php echo app('translator')->get('loyalty::app.redeemStamps'); ?>
                                                </span>
                                            </div>
                                        </div>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'openStampRedemptionModal','class' => 'flex items-center text-xs','wire:loading.attr' => 'disabled']); ?>
                                                <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                </svg>
                                                <span><?php echo app('translator')->get('loyalty::app.redeem'); ?></span>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAddTip || $order->tip_amount > 0): ?>
                            ...
                            <div class="flex items-center justify-between gap-3 mt-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->tip_amount > 0 && $order->tip_note): ?>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 line-clamp-1">
                                                "<?php echo e($order->tip_note); ?>"
                                            </p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->tip_amount > 0 && !$canAddTip): ?>
                                        <span class="text-xs font-medium dark:text-white"><?php echo e(currency_format($order->tip_amount, $restaurant->currency_id)); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'addTipModal','class' => 'flex items-center text-xs']); ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->tip_amount > 0): ?>
                                                <span class="font-medium"><?php echo e(currency_format($order->tip_amount, $restaurant->currency_id)); ?></span>
                            ...
                            <div class="flex flex-col items-end">
                                ...
                                ?>
                                    ...
                                    <span class="text-lg font-bold text-gray-900 dark:text-white">
                                        <?php echo e(currency_format($correctedTotal, $restaurant->currency_id)); ?>
        ...
        <div class="p-3 my-3 shadow-sm bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <div class="flex items-center gap-2 mb-3">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    <?php echo app('translator')->get('modules.order.paymentInformation'); ?>
                </h3>
            </div>
            ...
            <!-- Payment History -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->payments->count()): ?>
                            ...
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <div class="p-1.5 bg-gray-100 rounded-full dark:bg-gray-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($payment->payment_method):
                                            case ('stripe'): ?>
                                    ...
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->transaction_id): ?>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                <span class="font-medium"><?php echo app('translator')->get('modules.order.transactionId'); ?>:</span>
                                                <span class="font-mono"><?php echo e($payment->transaction_id); ?></span>
                                            </p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="text-right">
                                    <span class="text-lg font-semibold text-gray-900 dark:text-white">
                                        <?php echo e(currency_format($payment->amount, $restaurant->currency_id)); ?>

                                    </span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->balance > 0): ?>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                            <?php echo app('translator')->get('modules.order.balanceReturn'); ?>:
                                            <span class="font-medium">
                                                <?php echo e(currency_format($payment->balance, $restaurant->currency_id)); ?>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <?php echo app('translator')->get('modules.order.paid'); ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-link','data' => ['wire:navigate' => true,'class' => 'inline-flex items-center justify-center w-1/2 gap-2','href' => ''.e($newOrderLink).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:navigate' => true,'class' => 'inline-flex items-center justify-center w-1/2 gap-2','href' => ''.e($newOrderLink).'']); ?>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === 'pending_verification'): ?>
                        <?php echo app('translator')->get('modules.order.pendingPaymentVerification'); ?>
                    <?php else: ?>
                        <?php echo app('translator')->get('modules.order.paymentPending'); ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb5e767ad160784309dfcad41e788743b)): ?>
...
<?php endif; ?>
                ...
                <div class="flex gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_null($customer) && ($restaurant->customer_login_required || $orderType == 'delivery')): ?>
                        <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
                    ...
                    <?php else: ?>
                        <div class="grid w-full grid-cols-3 gap-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPayNow): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order && $order->order_status->value !== 'cancelled' && $order->status !== 'pending_verification'): ?>
                                    <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'items-center w-full','wire:click' => 'InitializePayment','wire:loading.attr' => 'disabled']); ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginala6c1b2378c7a756a2b58951b1494d68f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala6c1b2378c7a756a2b58951b1494d68f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-link','data' => ['wire:navigate' => true,'class' => 'inline-flex items-center justify-center gap-2','href' => ''.e($newOrderLink).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:navigate' => true,'class' => 'inline-flex items-center justify-center gap-2','href' => ''.e($newOrderLink).'']); ?>
                                <?php echo app('translator')->get('modules.order.newOrder'); ?>
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                </svg>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <div class="flex items-center justify-between p-2 mb-4 rounded-md cursor-pointer bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="inline-flex flex-col text-base font-semibold text-right text-gray-900 dark:text-white">
                        <div><?php echo e(currency_format($total, $restaurant->currency_id)); ?></div>
                    </div>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => ''.e($showQrCode ? 'toggleQrCode' : 'togglePaymentDetail').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => ''.e($showQrCode ? 'toggleQrCode' : 'togglePaymentDetail').'']); ?>
                ...
                <?php else: ?>
                    <div class="grid items-center w-full grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->stripe_status): ?>
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiateStripePayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiateStripePayment('.e($paymentOrder->id).')']); ?>
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->razorpay_status): ?>
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiatePayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiatePayment('.e($paymentOrder->id).')']); ?>
                                    <span class="inline-flex items-center">
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiateFlutterwavePayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiateFlutterwavePayment('.e($paymentOrder->id).')']); ?>
                                <span class="inline-flex items-center">
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiatePaypalPayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiatePaypalPayment('.e($paymentOrder->id).')']); ?>
                                <span class="inline-flex items-center">
...
<?php endif; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                             ...
                             <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->payfast_status): ?>
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiatePayfastPayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiatePayfastPayment('.e($paymentOrder->id).')']); ?>
                                    <span class="inline-flex items-center">
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->paystack_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiatePaystackPayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiatePaystackPayment('.e($paymentOrder->id).')']); ?>
                                <span class="inline-flex items-center">
                                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#0AA5FF">
                                        <path d="M2 3.6c0-.331.269-.6.6-.6H21.4c.331 0 .6.269.6.6v1.8a.6.6 0 0 1-.6.6H2.6a.6.6 0 0 1-.6-.6V3.6Zm0 4.8c0-.331.269-.6.6-.6H15.4c.331 0 .6.269.6.6v1.8a.6.6 0 0 1-.6.6H2.6a.6.6 0 0 1-.6-.6V8.4Zm0 4.8c0-.331.269-.6.6-.6H21.4c.331 0 .6.269.6.6v1.8a.6.6 0 0 1-.6.6H2.6a.6.6 0 0 1-.6-.6v-1.8Zm0 4.8c0-.331.269-.6.6-.6H15.4c.331 0 .6.269.6.6v1.8a.6.6 0 0 1-.6.6H2.6a.6.6 0 0 1-.6-.6v-1.8Z" fill-rule="evenodd"/>
                                    </svg>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->xendit_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiateXenditPayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiateXenditPayment('.e($paymentOrder->id).')']); ?>
                                <span class="inline-flex items-center">
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->epay_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiateEpayPayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiateMolliePayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiateMolliePayment('.e($paymentOrder->id).')']); ?>
                                <span class="inline-flex items-center">
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->tap_status): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'initiateTapPayment('.e($paymentOrder->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'initiateTapPayment('.e($paymentOrder->id).')']); ?>
                                <span class="inline-flex items-center">
...
<?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentGateway->is_qr_payment_enabled && $paymentGateway->qr_code_image_url): ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'toggleQrCode']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'toggleQrCode']); ?>
                                    <span class="inline-flex items-center">
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($offlinePaymentMethods) > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $offlinePaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offlineMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'makePayment('.e($paymentOrder->id).', \''.e($offlineMethod->name).'\')','wire:loading.attr' => 'disabled','wire:target' => 'makePayment']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'makePayment('.e($paymentOrder->id).', \''.e($offlineMethod->name).'\')','wire:loading.attr' => 'disabled','wire:target' => 'makePayment']); ?>
                                        <span class="inline-flex items-center">
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ml-3','wire:click' => 'makePayment('.e($paymentOrder->id).', \''.e($showQrCode ? 'upi' : 'others').'\')','wire:loading.attr' => 'disabled']); ?><?php echo app('translator')->get('modules.billing.paymentDone'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
<?php unset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'suggestedTip','value' => ''.e(__('modules.order.suggestedTip')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'suggestedTip','value' => ''.e(__('modules.order.suggestedTip')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    <div class="grid grid-cols-4 gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [5, 10, 15, 20]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $percentage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $calculatedTip = round($order->sub_total * $percentage / 100, 2);
                            ?>
                            <button type="button"
                                wire:click="$set('tipAmount', <?php echo e($calculatedTip); ?>)"
                                class="relative px-4 py-3 text-sm font-medium rounded-xl border-2
                                    <?php echo e($tipAmount == $calculatedTip
                            ...
                            >
                                <div class="font-bold"><?php echo e($percentage); ?>%</div>
                                <div class="text-xs text-gray-500 break-words dark:text-gray-400">
                                    <?php echo e(currency_format($calculatedTip, $restaurant->currency_id)); ?>
...
<?php endif; ?>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <span class="text-gray-500 dark:text-gray-400"><?php echo e($restaurant->currency->currency_symbol); ?></span>
                        </div>
...
<?php endif; ?>
                ...
                <div>
                    <label for="tipNote" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <span class="text-xs text-gray-400">(<?php echo app('translator')->get('app.optional'); ?>)</span>
                    </label>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPointsEnabledForCustomerSite ?? false): ?>
        <?php if (isset($component)) { $__componentOriginal49bd1c1dd878e22e0fb84faabf295a3f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bd1c1dd878e22e0fb84faabf295a3f = $attributes; } ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 mb-6 rounded-lg bg-gray-50 dark:bg-gray-700">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400"><?php echo app('translator')->get('modules.order.subTotal'); ?></span>
                                    <span class="font-medium"><?php echo e(currency_format($previewSubTotal, $restaurant->currency_id)); ?></span>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($order->discount_amount ?? 0) > 0): ?>
                                    <div class="flex justify-between text-green-600 dark:text-green-400">
                                        <span><?php echo app('translator')->get('modules.order.discount'); ?></span>
                                        <span class="font-medium">- <?php echo e(currency_format($order->discount_amount, $restaurant->currency_id)); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="flex justify-between text-blue-600 dark:text-blue-400">
                                    <span><?php echo app('translator')->get('loyalty::app.loyaltyDiscount'); ?></span>
                                    <span class="font-medium">- <?php echo e(currency_format($previewDiscount, $restaurant->currency_id)); ?></span>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($previewTaxAmount > 0): ?>
                                    <div class="flex justify-between text-gray-600 dark:text-gray-400">
                                        <span><?php echo app('translator')->get('modules.order.totalTax'); ?></span>
                                        <span class="font-medium"><?php echo e(currency_format($previewTaxAmount, $restaurant->currency_id)); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($previewCharges > 0): ?>
                                    <div class="flex justify-between text-gray-600 dark:text-gray-400">
                                        <span><?php echo app('translator')->get('modules.order.extraCharges'); ?></span>
                                        <span class="font-medium"><?php echo e(currency_format($previewCharges, $restaurant->currency_id)); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($order->tip_amount ?? 0) > 0): ?>
                                    <div class="flex justify-between text-gray-600 dark:text-gray-400">
                                        <span><?php echo app('translator')->get('modules.order.tip'); ?></span>
                                        <span class="font-medium"><?php echo e(currency_format($order->tip_amount, $restaurant->currency_id)); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($order->delivery_fee ?? 0) > 0): ?>
                                    <div class="flex justify-between text-gray-600 dark:text-gray-400">
                                        <span><?php echo app('translator')->get('modules.delivery.deliveryFee'); ?></span>
                                        <span class="font-medium"><?php echo e(currency_format($order->delivery_fee, $restaurant->currency_id)); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="pt-2 mt-2 border-t border-gray-200 dark:border-gray-800">
                                    <div class="flex justify-between">
                                        <span class="font-medium"><?php echo app('translator')->get('modules.order.newTotal'); ?></span>
                                        <span class="text-lg font-bold">
                                            <?php echo e(currency_format($newTotal, $restaurant->currency_id)); ?>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'number','value' => ''.e($maxRedeemablePoints).'','disabled' => true,'readonly' => true,'class' => 'block w-full bg-gray-100 dark:bg-gray-700 cursor-not-allowed','placeholder' => ''.e(__('loyalty::app.enterPoints')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'number','value' => ''.e($maxRedeemablePoints).'','disabled' => true,'readonly' => true,'class' => 'block w-full bg-gray-100 dark:bg-gray-700 cursor-not-allowed','placeholder' => ''.e(__('loyalty::app.enterPoints')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php endif; ?>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($maxRedeemablePoints > 0): ?>
                                        <?php echo e(__('Maximum applicable points based on order subtotal')); ?>: <?php echo e(number_format($maxRedeemablePoints)); ?> <?php echo app('translator')->get('loyalty::app.points'); ?>
                                    <?php else: ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'redeemLoyaltyPoints('.e($maxRedeemablePoints).')','wire:loading.attr' => 'disabled']); ?>
                        <?php echo e(__('loyalty::app.redeem')); ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isStampsEnabledForCustomerSite ?? false): ?>
            <?php if (isset($component)) { $__componentOriginal49bd1c1dd878e22e0fb84faabf295a3f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bd1c1dd878e22e0fb84faabf295a3f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dialog-modal','data' => ['wire:model.live' => 'showStampRedemptionModal','maxWidth' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dialog-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showStampRedemptionModal','maxWidth' => 'md']); ?>
                 <?php $__env->slot('title', null, []); ?> 
                    <div class="flex items-center gap-2">
                        <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <?php echo e(__('loyalty::app.redeemStamps')); ?>

                    </div>
                 <?php $__env->endSlot(); ?>

                 <?php $__env->slot('content', null, []); ?> 
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer && !empty($customerStamps)): ?>
                        <?php
                            $redeemableStamps = collect($customerStamps)->filter(function ($stampData) {
                                return $stampData['can_redeem'] ?? false;
                            });
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($redeemableStamps->count() > 0): ?>
                            <div class="space-y-4">
                                <div class="p-4 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                                    <p class="text-sm font-medium text-green-900 dark:text-green-200 mb-2">
                                        <?php echo e(__('loyalty::app.selectStampRuleToRedeem')); ?>

                                    </p>
                                </div>

                                <div class="space-y-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $redeemableStamps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stampData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $rule = $stampData['rule'];
                                        ...
                                        ?>
                                        <div class="border rounded-lg p-4 cursor-pointer transition-colors <?php echo e($isSelected ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600'); ?>"
                                             wire:click="toggleStampRuleSelection(<?php echo e($rule->id); ?>)">
                                            <div class="flex items-start justify-between gap-3">
                                                <!-- Checkbox -->
                                                <div class="flex-shrink-0 mt-1">
                                                    <input type="checkbox"
                                                           ...
                                                           wire:click.stop="toggleStampRuleSelection(<?php echo e($rule->id); ?>)"
                                                ...
                                                <div class="flex-1">
                                                    <div class="flex items-center gap-2 mb-2">
                                                        <h4 class="font-semibold text-gray-900 dark:text-white">
                                                            <?php echo e($menuItem->item_name ?? __('loyalty::app.unknownItem')); ?>
                                                    ...
                                                    <p class="text-xs text-gray-600 dark:text-gray-400 mb-2">
                                                        <?php echo e(__('loyalty::app.stampsRequired')); ?>: <?php echo e($stampsRequired); ?> |
                                                        <?php echo e(__('loyalty::app.stampsEarned')); ?>: <?php echo e($availableStamps); ?>

                                                    </p>
                                                    <div class="text-sm text-gray-700 dark:text-gray-300">
                                                        <span class="font-medium"><?php echo e(__('loyalty::app.reward')); ?>:</span>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rule->reward_type === 'free_item'): ?>
                                                            <span class="text-green-600 dark:text-green-400">
                                                                <?php echo e(__('loyalty::app.freeItem')); ?>: <?php echo e($rewardMenuItem->item_name ?? __('loyalty::app.unknownItem')); ?>

                                                            </span>
                                                        <?php elseif($rule->reward_type === 'discount_percent'): ?>
                                                            <span class="text-green-600 dark:text-green-400">
                                                                <?php echo e($rule->reward_value); ?>% <?php echo e(__('loyalty::app.discount')); ?>

                                                            </span>
                                                        <?php elseif($rule->reward_type === 'discount_amount'): ?>
                                                            <span class="text-green-600 dark:text-green-400">
                                                                <?php echo e(currency_format($rule->reward_value, $restaurant->currency_id)); ?> <?php echo e(__('loyalty::app.discount')); ?>
                        ...
                        <?php else: ?>
                            <div class="text-center py-8">
                                <p class="text-gray-500 dark:text-gray-400"><?php echo e(__('loyalty::app.noStampsAvailable')); ?></p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php else: ?>
                        <div class="text-center py-8">
...
<?php $attributes = $attributes->except(\App\View\Components\ButtonCancel::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'closeStampRedemptionModal','wire:loading.attr' => 'disabled']); ?>
                            <?php echo e(__('app.cancel')); ?>
...
<?php unset($__componentOriginala6eb8d48d97827815852966e89cf193a); ?>
<?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selectedStampRuleIds) && count($selectedStampRuleIds) > 0): ?>
                            <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'redeemStamps','wire:loading.attr' => 'disabled']); ?>
                                <?php echo e(__('loyalty::app.redeem')); ?> (<?php echo e(count($selectedStampRuleIds)); ?>)
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'redeemStamps','wire:loading.attr' => 'disabled','disabled' => true]); ?>
                                <?php echo e(__('loyalty::app.redeem')); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addCelebrationEffect(element) {
                ...
                try {
                    const audio = new Audio("<?php echo e(asset('sound/sound_beep-29.mp3')); ?>");
                    audio.volume = 0.3;
                    audio.play();
                } catch (e) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\shop\order-detail.blade.php ENDPATH**/ ?>