    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
        <div class="mb-4">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white text-center">
                <?php echo e(__('auth.loginViaOneTimePassword')); ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between mt-6">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                        ← <?php echo e(__('auth.backToLogin')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'button']); ?>
            ...
            <form method="POST" action="<?php echo e(route('otp.verify')); ?>">
                ...
                <div class="mb-4">
                    <p class="text-sm text-gray-600 dark:text-gray-400 text-center">
                        <?php echo e(__('auth.weveSentA6DigitCodeTo')); ?><br>
                        <span class="font-medium"><?php echo e(session('email')); ?></span>
                    </p>
                </div>
                ...
                <div>
                    <?php if (isset($component)) { $__componentOriginald8ba2b4c22a13c55321e34443c386276 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8ba2b4c22a13c55321e34443c386276 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'otp','value' => ''.e(__('auth.enter6DigitCode')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'otp','value' => ''.e(__('auth.enter6DigitCode')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald8ba2b4c22a13c55321e34443c386276)): ?>
<?php $attributes = $__attributesOriginald8ba2b4c22a13c55321e34443c386276; ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between mt-6">
                    <button type="button" onclick="resendOtp()" class="text-sm text-blue-600 hover:text-blue-700" id="resendBtn" disabled>
                        <?php echo e(__('auth.resendOtp')); ?> (<span id="countdown">60</span>s)
                    </button>
                    <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-center mt-4">
            <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-500 underline underline-offset-1">
    ...
    <script>
        ...
        function resendOtp() {
            ...
            resendBtn.innerHTML = '<?php echo e(__("auth.sending")); ?>';
            ...
            .then(data => {
                if (data.success) {
                    ...
                    successMessage.textContent = '<?php echo e(__("auth.newOtpSentSuccessfully")); ?>';
                    ...
                    alert('<?php echo e(__("auth.failedToResendOtp")); ?>');
                    resendBtn.disabled = false;
                    resendBtn.innerHTML = '<?php echo e(__("auth.resendOtp")); ?>';
                }
            })
            .catch(error => {
...
<?php endif; ?> <?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\auth\otp-login.blade.php ENDPATH**/ ?>