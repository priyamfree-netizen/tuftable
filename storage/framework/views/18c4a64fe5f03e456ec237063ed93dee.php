...
<?php $__env->startSection('title', 'About TufTable | Restaurant Management Software India'); ?>
    ...
    <div class="container">
        <div class="inner_banner-content-block">
            ...
            <ul class="banner__page-navigator">
                ...
                <li class="active"><a href="<?php echo e(route('landing.about')); ?>">About Us</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xxl-6 col-lg-7 col-md-10 col-auto" data-aos="fade-left" data-aos-duration="1000">
                <div class="content">
                    <div class="content-text-block">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty(global_setting()->about_us)): ?>
                            <div class="trix-content"><?php echo global_setting()->about_us; ?></div>
                        <?php else: ?>
            ...
            <div class="col-xxl-auto col-lg-7 col-md-10 col-auto">
                <div class="content">
                    ...
                    <div class="content-button-block">
                        <a href="<?php echo e(route('restaurant_signup')); ?>" class="btn-masco btn-primary rounded-pill btn-fill--up">
...
<div class="about_feature-section section-padding-120 bg-light-2">
    <div class="container">
        ...
        <div class="row feature-widget-7-row">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon,$title,$desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6 col-xs-8 col-9">
                <div class="feature-widget-7">
                    <div class="feature-widget-7__icon-wrapper">
                        <img src="<?php echo e($icon); ?>" alt="<?php echo e($title); ?>" style="width:56px;height:56px;object-fit:contain;" />
                    </div>
                    <div class="feature-widget-7__body">
                        <h4 class="feature-widget-7__title"><?php echo e($title); ?></h4>
                        <p><?php echo e($desc); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.landing-page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Priyam\Documents\GitHub\tuftable\resources\views/landing/about-page.blade.php ENDPATH**/ ?>