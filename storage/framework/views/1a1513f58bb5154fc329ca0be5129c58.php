<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$restaurant->enable_customer_reservation): ?>
        <div class="flex flex-col items-center justify-center py-12">
            <div class="text-center">
                ...
                <h3 class="mb-2 text-lg font-medium text-gray-900 dark:text-white">
                    <?php echo app('translator')->get('modules.reservation.reservationsDisabled'); ?>
                </h3>
                <p class="mb-4 text-gray-500 dark:text-gray-400">
                    <?php echo app('translator')->get('modules.reservation.reservationsDisabledDescription'); ?>
                </p>
            </div>
        </div>
    <?php else: ?>
    <section class="bg-white dark:bg-gray-900 hidden lg:block px-4">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 bg-skin-base/[.1] dark:bg-gray-800 rounded-lg">
            <h1 class="text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-3xl dark:text-white"><?php echo app('translator')->get('messages.frontReservationHeading'); ?></h1>
        </div>
    </section>

    <div class="space-y-8 max-w-4xl mx-auto lg:mt-20 p-4">
        <h4 class="text-2xl font-bold dark:text-white"><?php echo app('translator')->get('messages.selectBookingDetail'); ?></h4>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datepicker','data' => ['wire:model.defer' => 'date','minDate' => ''.e($minDate).'','maxDate' => ''.e($maxDate).'','restaurant' => $restaurant]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.defer' => 'date','minDate' => ''.e($minDate).'','maxDate' => ''.e($maxDate).'','restaurant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($restaurant)]); ?>
                ...
                <div wire:key='reservation-date-2' id="dropdownHover2" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-full dark:bg-gray-700 max-w-60">
                    <ul class="py-2 text-gray-700 dark:text-gray-200 max-h-72 overflow-auto" aria-labelledby="dropdownHoverButton2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 30; $i++): ?>
                            <li>
                                <a href="javascript:;" wire:click="setReservationGuest('<?php echo e($i); ?>')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-md">
                                    <?php echo e($i); ?> <?php echo app('translator')->get('modules.reservation.guests'); ?>
                                </a>
                            </li>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="relative">
                ...
                <div wire:key='reservation-date-3' id="dropdownHover3" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-full dark:bg-gray-700 max-w-60">
                    <ul class="py-2 text-gray-700 dark:text-gray-200 max-h-72 overflow-auto" aria-labelledby="dropdownHoverButton3">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $slotTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $isSlotTypeDisabled = !isset($availableSlotTypes[$type]) || !in_array($selectedDay, $availableSlotTypes[$type] ?? []);
                            ?>
                            <li>
                                <a href="javascript:;"
                                    wire:click="setReservationSlotType('<?php echo e($type); ?>')"
                                    ...
                                    <?php echo app('translator')->get('modules.reservation.' . $type); ?>
                                </a>
                            </li>
        ...
        <div class="relative">
            ...
            <div wire:loading.class="opacity-50 pointer-events-none" class="mt-2 space-y-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($timeSlots) || !$this->isSlotTypeAvailable()): ?>
...
<?php endif; ?>
                ...
                <ul class="grid w-full lg:gap-6 gap-4 lg:grid-cols-6 md:grid-cols-4 grid-cols-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <li wire:key="timeSlot.<?php echo e($loop->index); ?>">
                            <input type="radio" id="timeSlot<?php echo e($loop->index); ?>" wire:model.live="availableTimeSlots" value="<?php echo e($timeSlot); ?>" class="hidden peer" <?php echo e($isDisabled ? 'disabled' : ''); ?> />
                            <label for="timeSlot<?php echo e($loop->index); ?>"
                                class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php $component->withAttributes(['type' => 'button','wire:click' => 'submitReservation','wire:loading.attr' => 'disabled','class' => 'w-full md:w-auto inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-skin-base hover:bg-skin-base-dark focus:ring-4 focus:ring-skin-base-light dark:focus:ring-skin-base-dark transition-all duration-200']); ?>
                        ...
                        <?php echo app('translator')->get('app.reserveNow'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\livewire\shop\book-a-table.blade.php ENDPATH**/ ?>