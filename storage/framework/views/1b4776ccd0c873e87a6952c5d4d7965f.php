<!DOCTYPE html>
<html lang="<?php echo e(session('customer_locale') ?? $restaurant->customer_site_language); ?>" dir="<?php echo e(session('customer_is_rtl') ? 'rtl' : 'ltr'); ?>">

<head>
    <link rel="manifest" href="<?php echo e(url('manifest.json')); ?>?url=<?php echo e(urlencode(ltrim(Request::getRequestUri(), '/'))); ?>&hash=<?php echo e($restaurant->hash); ?>" crossorigin="use-credentials">
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e($restaurant->uploadFavIconAppleTouchIconUrl); ?>">
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo e($restaurant->uploadFavIconAndroidChrome192Url); ?>">
    <link rel="icon" type="image/png" sizes="512x512" href="<?php echo e($restaurant->uploadFavIconAndroidChrome512Url); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e($restaurant->uploadFavIcon16Url); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e($restaurant->uploadFavIcon32Url); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('vendor/pikaday.css')); ?>" />

    <link rel="shortcut icon" href="<?php echo e($restaurant->faviconUrl); ?>">

    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?php echo e($restaurant->logoUrl); ?>">


    <meta name="keyword" content="<?php echo e($restaurant->meta_keyword ?? ''); ?>">
    <meta name="description" content="<?php echo e($restaurant->meta_description ?? $restaurant->name); ?>">
    ...
    <style>
        :root {
            ...
            --color-base: <?php echo e($restaurant->theme_rgb); ?>;
            --livewire-progress-bar-color: <?php echo e($restaurant->theme_hex); ?>;
        }
    </style>
    ...
    <?php if ($__env->exists('sections.custom_script_customer')) echo $__env->make('sections.custom_script_customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
[$__name, $__params] = $__split('shopNavigation', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch]);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-916183318-0', null);
...
[$__name, $__params] = $__split('shopDesktopNavigation', ['restaurant' => $restaurant, 'shopBranch' => $shopBranch]);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-916183318-1', null);
    ...
    <footer class="p-4 bg-white sm:p-6 dark:bg-gray-800 border-t dark:border-gray-600">
        <div class="mx-auto max-w-screen-xl">
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; <?php echo e(now()->year); ?> <a
                        href="" class="hover:underline"><?php echo e($restaurant->name); ?></a>. <?php echo app('translator')->get('app.allRightsReserved'); ?>
                </span>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-916183318-2', null);
...
?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->instagram_link): ?>
                        <a href="<?php echo e($restaurant->instagram_link); ?>"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->twitter_link): ?>
                        <a href="<?php echo e($restaurant->twitter_link); ?>"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->yelp_link): ?>
                        <a href="<?php echo e($restaurant->yelp_link); ?>"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->paymentGateways->razorpay_status): ?>
        <script src="https://checkout.razorpay.com/v1/checkout.js"></script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->paymentGateways->epay_status): ?>
        <?php
        ...
        ?>
        <script src="<?php echo e($epayJsUrl); ?>"></script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->paymentGateways->stripe_status): ?>
        <script src="https://js.stripe.com/v3/"></script>

        <form action="<?php echo e(route('stripe.order_payment')); ?>" method="POST" id="order-payment-form" class="hidden">
            <?php echo csrf_field(); ?>
        ...
        <script>
            const stripe = Stripe('<?php echo e($restaurant->paymentGateways->stripe_key); ?>');
    ...
    <script>
        <?php if($restaurant->is_pwa_install_alert_show == 1): ?>
            ...
            function showIOSInstallInstructions() {
                ...
                instructions.innerHTML = `
                 ...
                 <div style="position: fixed; bottom: 10px; left: 10px; right: 10px; background: #fff; padding: 10px; border: 1px solid #ccc; border-radius: 5px; text-align: center; z-index: 1000;">
                    <p class="flex relative"><?php echo app('translator')->get('messages.installAppInstruction'); ?>
                        <img class="absolute right-0 left-auto mr-5" src="<?php echo e(asset('img/share-ios.svg')); ?>" alt="Share Icon" style="width: 20px; vertical-align: middle;">

                    </p>
                    <?php echo app('translator')->get('messages.addToHomeScreen'); ?>.
                    <button id="closeInstructions" class="block text-center mx-auto" style="margin-top: 10px; padding: 5px 10px;"><?php echo app('translator')->get('app.close'); ?></button>
                </div>
            `;
...
<?php /**PATH C:\Users\denji\Downloads\TableTrack v1.2.70 Nulled\script\script\resources\views\layouts\guest.blade.php ENDPATH**/ ?>